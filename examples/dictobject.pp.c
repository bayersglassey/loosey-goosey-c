...
__attribute__ ((visibility ("default"))) PyObject * _PyObject_Call_Prepend(
    PyThreadState *tstate,
    PyObject *callable,
    PyObject *obj,
    PyObject *args,
    PyObject *kwargs);
__attribute__ ((visibility ("default"))) PyObject * _PyObject_FastCallDictTstate(
    PyThreadState *tstate,
    PyObject *callable,
    PyObject *const *args,
    size_t nargsf,
    PyObject *kwargs);
__attribute__ ((visibility ("default"))) PyObject * _PyObject_Call(
    PyThreadState *tstate,
    PyObject *callable,
    PyObject *args,
    PyObject *kwargs);
...
{
    ((void) sizeof ((callable != ((void *)0)) ? 1 : 0), __extension__ ({ if (callable != ((void *)0)) ; else __assert_fail ("callable != NULL", "/usr/include/python3.12/internal/pycore_call.h", 41, __extension__ __PRETTY_FUNCTION__); }));
    PyTypeObject *tp = Py_TYPE(((PyObject*)((callable))));
    if (!PyType_HasFeature(tp, (1UL << 11))) {
        return ((void *)0);
    }
    ((void) sizeof ((PyCallable_Check(callable)) ? 1 : 0), __extension__ ({ if (PyCallable_Check(callable)) ; else __assert_fail ("PyCallable_Check(callable)", "/usr/include/python3.12/internal/pycore_call.h", 47, __extension__ __PRETTY_FUNCTION__); }));
    Py_ssize_t offset = tp->tp_vectorcall_offset;
    ((void) sizeof ((offset > 0) ? 1 : 0), __extension__ ({ if (offset > 0) ; else __assert_fail ("offset > 0", "/usr/include/python3.12/internal/pycore_call.h", 50, __extension__ __PRETTY_FUNCTION__); }));
    vectorcallfunc ptr;
                           ...
                           PyObject *kwnames)
{
    vectorcallfunc func;
    PyObject *res;
    ((void) sizeof ((kwnames == ((void *)0) || PyType_HasFeature((Py_TYPE(((PyObject*)((kwnames))))), ((1UL << 26)))) ? 1 : 0), __extension__ ({ if (kwnames == ((void *)0) || PyType_HasFeature((Py_TYPE(((PyObject*)((kwnames))))), ((1UL << 26)))) ; else __assert_fail ("kwnames == NULL || PyTuple_Check(kwnames)", "/usr/include/python3.12/internal/pycore_call.h", 84, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((args != ((void *)0) || _PyVectorcall_NARGS(nargsf) == 0) ? 1 : 0), __extension__ ({ if (args != ((void *)0) || _PyVectorcall_NARGS(nargsf) == 0) ; else __assert_fail ("args != NULL || PyVectorcall_NARGS(nargsf) == 0", "/usr/include/python3.12/internal/pycore_call.h", 85, __extension__ __PRETTY_FUNCTION__); }));
...
static inline PyDictKeyEntry* DK_ENTRIES(PyDictKeysObject *dk) {
    ((void) sizeof ((dk->dk_kind == DICT_KEYS_GENERAL) ? 1 : 0), __extension__ ({ if (dk->dk_kind == DICT_KEYS_GENERAL) ; else __assert_fail ("dk->dk_kind == DICT_KEYS_GENERAL", "/usr/include/python3.12/internal/pycore_dict.h", 139, __extension__ __PRETTY_FUNCTION__); }));
    return (PyDictKeyEntry*)_DK_ENTRIES(dk);
}
static inline PyDictUnicodeEntry* DK_UNICODE_ENTRIES(PyDictKeysObject *dk) {
    ((void) sizeof ((dk->dk_kind != DICT_KEYS_GENERAL) ? 1 : 0), __extension__ ({ if (dk->dk_kind != DICT_KEYS_GENERAL) ; else __assert_fail ("dk->dk_kind != DICT_KEYS_GENERAL", "/usr/include/python3.12/internal/pycore_dict.h", 143, __extension__ __PRETTY_FUNCTION__); }));
...
_PyDict_NotifyEvent(PyInterpreterState *interp,
                    ...
                    PyObject *value)
{
    ((void) sizeof ((Py_REFCNT(((PyObject*)(((PyObject*)mp)))) > 0) ? 1 : 0), __extension__ ({ if (Py_REFCNT(((PyObject*)(((PyObject*)mp)))) > 0) ; else __assert_fail ("Py_REFCNT((PyObject*)mp) > 0", "/usr/include/python3.12/internal/pycore_dict.h", 169, __extension__ __PRETTY_FUNCTION__); }));
    int watcher_bits = mp->ma_version_tag & ((1 << 8) - 1);
    if (watcher_bits) {
        _PyDict_SendEvent(watcher_bits, event, mp, key, value);
        return ((interp)->dict_state.global_version += (1 << 8)) | watcher_bits;
    }
    return ((interp)->dict_state.global_version += (1 << 8));
}
...
{
    ((void) sizeof ((ix < 30) ? 1 : 0), __extension__ ({ if (ix < 30) ; else __assert_fail ("ix < SHARED_KEYS_MAX_SIZE", "/usr/include/python3.12/internal/pycore_dict.h", 187, __extension__ __PRETTY_FUNCTION__); }));
    uint8_t *size_ptr = ((uint8_t *)values)-2;
    int size = *size_ptr;
    ((void) sizeof ((size+2 < ((uint8_t *)values)[-1]) ? 1 : 0), __extension__ ({ if (size+2 < ((uint8_t *)values)[-1]) ; else __assert_fail ("size+2 < ((uint8_t *)values)[-1]", "/usr/include/python3.12/internal/pycore_dict.h", 190, __extension__ __PRETTY_FUNCTION__); }));
    size++;
...
{
    ((void) sizeof ((tstate != ((void *)0)) ? 1 : 0), __extension__ ({ if (tstate != ((void *)0)) ; else __assert_fail ("tstate != NULL", "/usr/include/python3.12/internal/pycore_pyerrors.h", 22, __extension__ __PRETTY_FUNCTION__); }));
    if (tstate->current_exception == ((void *)0)) {
        return ((void *)0);
    }
...
{
    do { __typeof__(exc_state->exc_value)* _tmp_op_ptr = &(exc_state->exc_value); __typeof__(exc_state->exc_value) _tmp_old_op = (*_tmp_op_ptr); if (_tmp_old_op != ((void *)0)) { *_tmp_op_ptr = ((void *)0); Py_DECREF(((PyObject*)((_tmp_old_op)))); } } while (0);
}
__attribute__ ((visibility ("default"))) PyObject* _PyErr_StackItemToExcInfoTuple(
    _PyErr_StackItem *err_info);
__attribute__ ((visibility ("default"))) void _PyErr_Fetch(
    PyThreadState *tstate,
    PyObject **type,
    PyObject **value,
    PyObject **traceback);
...
__attribute__ ((visibility ("default"))) void _PyErr_Restore(
    PyThreadState *tstate,
    PyObject *type,
    PyObject *value,
    PyObject *traceback);
__attribute__ ((visibility ("default"))) void _PyErr_SetObject(
    PyThreadState *tstate,
    PyObject *type,
    PyObject *value);
__attribute__ ((visibility ("default"))) void _PyErr_ChainStackItem(
    _PyErr_StackItem *exc_info);
__attribute__ ((visibility ("default"))) void _PyErr_Clear(PyThreadState *tstate);
__attribute__ ((visibility ("default"))) void _PyErr_SetNone(PyThreadState *tstate, PyObject *exception);
__attribute__ ((visibility ("default"))) PyObject * _PyErr_NoMemory(PyThreadState *tstate);
...
__attribute__ ((visibility ("default"))) PyObject * _PyErr_Format(
    ...
    const char *format,
    ...);
__attribute__ ((visibility ("default"))) void _PyErr_NormalizeException(
    PyThreadState *tstate,
    PyObject **exc,
    PyObject **val,
    PyObject **tb);
__attribute__ ((visibility ("default"))) PyObject * _PyErr_FormatFromCauseTstate(
    PyThreadState *tstate,
    PyObject *exception,
    const char *format,
    ...);
__attribute__ ((visibility ("default"))) PyObject * _PyExc_CreateExceptionGroup(
    const char *msg,
    PyObject *excs);
__attribute__ ((visibility ("default"))) PyObject * _PyExc_PrepReraiseStar(
    PyObject *orig,
    PyObject *excs);
__attribute__ ((visibility ("default"))) int _PyErr_CheckSignalsTstate(PyThreadState *tstate);
__attribute__ ((visibility ("default"))) void _Py_DumpExtensionModules(int fd, PyInterpreterState *interp);
...
{
    if (PyUnicode_GET_LENGTH(((PyObject*)((a)))) != PyUnicode_GET_LENGTH(((PyObject*)((b)))))
        return 0;
    if (PyUnicode_GET_LENGTH(((PyObject*)((a)))) == 0)
        return 1;
    if (((void)0, ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((a))))), ((1UL << 28)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((a))))), ((1UL << 28)))) ; else __assert_fail ("PyUnicode_Check(a)", "/home/bag/repos/cpython/Objects/stringlib/eq.h", 13, __extension__ __PRETTY_FUNCTION__); })), ((PyASCIIObject*)((a))))->state.kind)) != ((void)0, ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((b))))), ((1UL << 28)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((b))))), ((1UL << 28)))) ; else __assert_fail ("PyUnicode_Check(b)", "/home/bag/repos/cpython/Objects/stringlib/eq.h", 13, __extension__ __PRETTY_FUNCTION__); })), ((PyASCIIObject*)((b))))->state.kind)))
        return 0;
    return memcmp(((Py_UCS1*)(PyUnicode_DATA(((PyObject*)((a)))))), ((Py_UCS1*)(PyUnicode_DATA(((PyObject*)((b)))))),
                  PyUnicode_GET_LENGTH(((PyObject*)((a)))) * ((void)0, ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((a))))), ((1UL << 28)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((a))))), ((1UL << 28)))) ; else __assert_fail ("PyUnicode_Check(a)", "/home/bag/repos/cpython/Objects/stringlib/eq.h", 16, __extension__ __PRETTY_FUNCTION__); })), ((PyASCIIObject*)((a))))->state.kind))) == 0;
}
...
dict_fromkeys(PyTypeObject *type, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!((!((2) == 0x7fffffffffffffffL) && (1) <= (nargs) && (nargs) <= (2)) || _PyArg_CheckPositional(("fromkeys"), (nargs), (1), (2)))) {
        goto exit;
    }
    iterable = args[0];
    if (nargs < 2) {
...
dict_get(PyDictObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!((!((2) == 0x7fffffffffffffffL) && (1) <= (nargs) && (nargs) <= (2)) || _PyArg_CheckPositional(("get"), (nargs), (1), (2)))) {
        goto exit;
    }
    key = args[0];
    if (nargs < 2) {
...
dict_setdefault(PyDictObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    PyObject *key;
    PyObject *default_value = (&_Py_NoneStruct);
    if (!((!((2) == 0x7fffffffffffffffL) && (1) <= (nargs) && (nargs) <= (2)) || _PyArg_CheckPositional(("setdefault"), (nargs), (1), (2)))) {
        goto exit;
    }
    key = args[0];
    if (nargs < 2) {
...
static const char dict_pop__doc__[] = "pop($self, key, default=<unrepresentable>, /)\n" "--\n" "\n" "D.pop(k[,d]) -> v, remove specified key and return the corresponding value.\n" "\n" "If the key is not found, return the default if given; otherwise,\n" "raise a KeyError.";
static PyObject *
...
dict_pop(PyDictObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!((!((2) == 0x7fffffffffffffffL) && (1) <= (nargs) && (nargs) <= (2)) || _PyArg_CheckPositional(("pop"), (nargs), (1), (2)))) {
        goto exit;
    }
    key = args[0];
    if (nargs < 2) {
...
_PyDict_ClearFreeList(PyInterpreterState *interp)
{
    ...
    while (state->numfree) {
        ...
        ((void) sizeof ((Py_IS_TYPE(((PyObject*)(((op)))), (&PyDict_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)(((op)))), (&PyDict_Type))) ; else __assert_fail ("PyDict_CheckExact(op)", "/home/bag/repos/cpython/Objects/dictobject.c", 259, __extension__ __PRETTY_FUNCTION__); }));
        PyObject_GC_Del(op);
    }
...
{
    ((void) sizeof ((Py_IS_TYPE(((PyObject*)(((o)))), (&PyUnicode_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)(((o)))), (&PyUnicode_Type))) ; else __assert_fail ("PyUnicode_CheckExact(o)", "/home/bag/repos/cpython/Objects/dictobject.c", 283, __extension__ __PRETTY_FUNCTION__); }));
    return (((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((o))))), ((1UL << 28)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((o))))), ((1UL << 28)))) ; else __assert_fail ("PyUnicode_Check(o)", "/home/bag/repos/cpython/Objects/dictobject.c", 284, __extension__ __PRETTY_FUNCTION__); })), ((PyASCIIObject*)((o))))->hash;
}
void
...
{
    if (dk->dk_refcnt == (0x7fffffff * 2U + 1U)) {
        return;
    }
    dk->dk_refcnt++;
}
...
dictkeys_decref(PyInterpreterState *interp, PyDictKeysObject *dk)
{
    ...
    ((void) sizeof ((dk->dk_refcnt > 0) ? 1 : 0), __extension__ ({ if (dk->dk_refcnt > 0) ; else __assert_fail ("dk->dk_refcnt > 0", "/home/bag/repos/cpython/Objects/dictobject.c", 328, __extension__ __PRETTY_FUNCTION__); }));
    if (--dk->dk_refcnt == 0) {
...
{
    int log2size = ((void)0, ((keys)->dk_log2_size));
    Py_ssize_t ix;
    if (log2size < 8) {
    ...
    ((void) sizeof ((ix >= (-2)) ? 1 : 0), __extension__ ({ if (ix >= (-2)) ; else __assert_fail ("ix >= DKIX_DUMMY", "/home/bag/repos/cpython/Objects/dictobject.c", 362, __extension__ __PRETTY_FUNCTION__); }));
    return ix;
}
static inline void
...
{
    int log2size = ((void)0, ((keys)->dk_log2_size));
    ((void) sizeof ((ix >= (-2)) ? 1 : 0), __extension__ ({ if (ix >= (-2)) ; else __assert_fail ("ix >= DKIX_DUMMY", "/home/bag/repos/cpython/Objects/dictobject.c", 372, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((keys->dk_version == 0) ? 1 : 0), __extension__ ({ if (keys->dk_version == 0) ; else __assert_fail ("keys->dk_version == 0", "/home/bag/repos/cpython/Objects/dictobject.c", 373, __extension__ __PRETTY_FUNCTION__); }));
    if (log2size < 8) {
        int8_t *indices = (int8_t*)(keys->dk_indices);
        ((void) sizeof ((ix <= 0x7f) ? 1 : 0), __extension__ ({ if (ix <= 0x7f) ; else __assert_fail ("ix <= 0x7f", "/home/bag/repos/cpython/Objects/dictobject.c", 377, __extension__ __PRETTY_FUNCTION__); }));
        indices[i] = (char)ix;
    }
    else if (log2size < 16) {
        int16_t *indices = (int16_t*)(keys->dk_indices);
        ((void) sizeof ((ix <= 0x7fff) ? 1 : 0), __extension__ ({ if (ix <= 0x7fff) ; else __assert_fail ("ix <= 0x7fff", "/home/bag/repos/cpython/Objects/dictobject.c", 382, __extension__ __PRETTY_FUNCTION__); }));
        ...
        ((void) sizeof ((ix <= 0x7fffffff) ? 1 : 0), __extension__ ({ if (ix <= 0x7fffffff) ; else __assert_fail ("ix <= 0x7fffffff", "/home/bag/repos/cpython/Objects/dictobject.c", 393, __extension__ __PRETTY_FUNCTION__); }));
...
{
    minsize = (minsize | 8) - 1;
    return _Py_bit_length(minsize | (8 -1));
}
static inline uint8_t
...
{
    ((void) sizeof ((mp->ma_used <= 30) ? 1 : 0), __extension__ ({ if (mp->ma_used <= 30) ; else __assert_fail ("mp->ma_used <= SHARED_KEYS_MAX_SIZE", "/home/bag/repos/cpython/Objects/dictobject.c", 491, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((i < (((char *)mp->ma_values)[-2])) ? 1 : 0), __extension__ ({ if (i < (((char *)mp->ma_values)[-2])) ; else __assert_fail ("i < (((char *)mp->ma_values)[-2])", "/home/bag/repos/cpython/Objects/dictobject.c", 492, __extension__ __PRETTY_FUNCTION__); }));
    return ((char *)mp->ma_values)[-3-i];
}
int
_PyDict_CheckConsistency(PyObject *op, int check_content)
{
    ((void) sizeof ((op != ((void *)0)) ? 1 : 0), __extension__ ({ if (op != ((void *)0)) ; else __assert_fail ("op != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 519, __extension__ __PRETTY_FUNCTION__); }));
    do { if (!(PyType_HasFeature((Py_TYPE(((PyObject*)((op))))), ((1UL << 29))))) { _PyObject_AssertFailed((op), ((void *)0), ("PyType_HasFeature((Py_TYPE(((PyObject*)((op))))), ((1UL << 29)))"), "/home/bag/repos/cpython/Objects/dictobject.c", 520, __func__); } } while (0);
    PyDictObject *mp = (PyDictObject *)op;
    PyDictKeysObject *keys = mp->ma_keys;
    int splitted = ((mp)->ma_values != ((void *)0));
    Py_ssize_t usable = ((((((int64_t)1)<<((void)0, ((keys)->dk_log2_size)))) << 1)/3);
    do { if (!(0 <= mp->ma_used && mp->ma_used <= usable)) { _PyObject_AssertFailed((op), ((void *)0), ("0 <= mp->ma_used && mp->ma_used <= usable"), "/home/bag/repos/cpython/Objects/dictobject.c", 527, __func__); } } while (0);
    do { if (!(0 <= keys->dk_usable && keys->dk_usable <= usable)) { _PyObject_AssertFailed((op), ((void *)0), ("0 <= keys->dk_usable && keys->dk_usable <= usable"), "/home/bag/repos/cpython/Objects/dictobject.c", 528, __func__); } } while (0);
    do { if (!(0 <= keys->dk_nentries && keys->dk_nentries <= usable)) { _PyObject_AssertFailed((op), ((void *)0), ("0 <= keys->dk_nentries && keys->dk_nentries <= usable"), "/home/bag/repos/cpython/Objects/dictobject.c", 529, __func__); } } while (0);
    do { if (!(keys->dk_usable + keys->dk_nentries <= usable)) { _PyObject_AssertFailed((op), ((void *)0), ("keys->dk_usable + keys->dk_nentries <= usable"), "/home/bag/repos/cpython/Objects/dictobject.c", 530, __func__); } } while (0);
    if (!splitted) {
        do { if (!(keys->dk_kind != DICT_KEYS_SPLIT)) { _PyObject_AssertFailed((op), ((void *)0), ("keys->dk_kind != DICT_KEYS_SPLIT"), "/home/bag/repos/cpython/Objects/dictobject.c", 534, __func__); } } while (0);
        do { if (!(keys->dk_refcnt == 1 || keys == &empty_keys_struct)) { _PyObject_AssertFailed((op), ((void *)0), ("keys->dk_refcnt == 1 || keys == &empty_keys_struct"), "/home/bag/repos/cpython/Objects/dictobject.c", 535, __func__); } } while (0);
    }
    else {
        do { if (!(keys->dk_kind == DICT_KEYS_SPLIT)) { _PyObject_AssertFailed((op), ((void *)0), ("keys->dk_kind == DICT_KEYS_SPLIT"), "/home/bag/repos/cpython/Objects/dictobject.c", 538, __func__); } } while (0);
        do { if (!(mp->ma_used <= 30)) { _PyObject_AssertFailed((op), ((void *)0), ("mp->ma_used <= 30"), "/home/bag/repos/cpython/Objects/dictobject.c", 539, __func__); } } while (0);
    }
    if (check_content) {
        for (Py_ssize_t i=0; i < (((int64_t)1)<<((void)0, ((keys)->dk_log2_size))); i++) {
            Py_ssize_t ix = dictkeys_get_index(keys, i);
            do { if (!((-2) <= ix && ix <= usable)) { _PyObject_AssertFailed((op), ((void *)0), ("(-2) <= ix && ix <= usable"), "/home/bag/repos/cpython/Objects/dictobject.c", 545, __func__); } } while (0);
        }
        if (keys->dk_kind == DICT_KEYS_GENERAL) {
            ...
            for (Py_ssize_t i=0; i < usable; i++) {
                ...
                if (key != ((void *)0)) {
                    do { if (!(entry->me_hash != -1)) { _PyObject_AssertFailed((op), ((void *)0), ("entry->me_hash != -1"), "/home/bag/repos/cpython/Objects/dictobject.c", 556, __func__); } } while (0);
                    do { if (!(entry->me_value != ((void *)0))) { _PyObject_AssertFailed((op), ((void *)0), ("entry->me_value != ((void *)0)"), "/home/bag/repos/cpython/Objects/dictobject.c", 557, __func__); } } while (0);
                    if (Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type))) {
                        Py_hash_t hash = unicode_get_hash(key);
                        do { if (!(entry->me_hash == hash)) { _PyObject_AssertFailed((op), ((void *)0), ("entry->me_hash == hash"), "/home/bag/repos/cpython/Objects/dictobject.c", 561, __func__); } } while (0);
                    }
                }
            }
        }
            ...
            for (Py_ssize_t i=0; i < usable; i++) {
                ...
                PyObject *key = entry->me_key;
                if (key != ((void *)0)) {
                    do { if (!(Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type)))) { _PyObject_AssertFailed((op), ((void *)0), ("Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type))"), "/home/bag/repos/cpython/Objects/dictobject.c", 573, __func__); } } while (0);
                    Py_hash_t hash = unicode_get_hash(key);
                    do { if (!(hash != -1)) { _PyObject_AssertFailed((op), ((void *)0), ("hash != -1"), "/home/bag/repos/cpython/Objects/dictobject.c", 575, __func__); } } while (0);
                    if (!splitted) {
                        do { if (!(entry->me_value != ((void *)0))) { _PyObject_AssertFailed((op), ((void *)0), ("entry->me_value != ((void *)0)"), "/home/bag/repos/cpython/Objects/dictobject.c", 577, __func__); } } while (0);
                    }
                }
                if (splitted) {
                    do { if (!(entry->me_value == ((void *)0))) { _PyObject_AssertFailed((op), ((void *)0), ("entry->me_value == ((void *)0)"), "/home/bag/repos/cpython/Objects/dictobject.c", 582, __func__); } } while (0);
                }
            }
        }
        if (splitted) {
            do { if (!(mp->ma_used <= 30)) { _PyObject_AssertFailed((op), ((void *)0), ("mp->ma_used <= 30"), "/home/bag/repos/cpython/Objects/dictobject.c", 588, __func__); } } while (0);
            int duplicate_check = 0;
            for (Py_ssize_t i=0; i < mp->ma_used; i++) {
                int index = get_index_from_order(mp, i);
                do { if (!((duplicate_check & (1<<index)) == 0)) { _PyObject_AssertFailed((op), ((void *)0), ("(duplicate_check & (1<<index)) == 0"), "/home/bag/repos/cpython/Objects/dictobject.c", 593, __func__); } } while (0);
                duplicate_check |= (1<<index);
                do { if (!(mp->ma_values->values[index] != ((void *)0))) { _PyObject_AssertFailed((op), ((void *)0), ("mp->ma_values->values[index] != ((void *)0)"), "/home/bag/repos/cpython/Objects/dictobject.c", 595, __func__); } } while (0);
            }
        }
    }
    return 1;
...
new_keys_object(PyInterpreterState *interp, uint8_t log2_size, _Bool unicode)
{
    PyDictKeysObject *dk;
    Py_ssize_t usable;
    int log2_bytes;
    size_t entry_size = unicode ? sizeof(PyDictUnicodeEntry) : sizeof(PyDictKeyEntry);
    ((void) sizeof ((log2_size >= 3) ? 1 : 0), __extension__ ({ if (log2_size >= 3) ; else __assert_fail ("log2_size >= PyDict_LOG_MINSIZE", "/home/bag/repos/cpython/Objects/dictobject.c", 613, __extension__ __PRETTY_FUNCTION__); }));
    usable = ((((size_t)1<<log2_size) << 1)/3);
    if (log2_size < 8) {
    ...
    struct _Py_dict_state *state = get_dict_state(interp);
    if (log2_size == 3 && unicode && state->keys_numfree > 0) {
...
{
    ((void) sizeof ((keys != &empty_keys_struct) ? 1 : 0), __extension__ ({ if (keys != &empty_keys_struct) ; else __assert_fail ("keys != Py_EMPTY_KEYS", "/home/bag/repos/cpython/Objects/dictobject.c", 670, __extension__ __PRETTY_FUNCTION__); }));
    if (((keys)->dk_kind != DICT_KEYS_GENERAL)) {
        PyDictUnicodeEntry *entries = DK_UNICODE_ENTRIES(keys);
        Py_ssize_t i, n;
        for (i = 0, n = keys->dk_nentries; i < n; i++) {
            Py_XDECREF(((PyObject*)((entries[i].me_key))));
    ...
    struct _Py_dict_state *state = get_dict_state(interp);
    if (((void)0, ((keys)->dk_log2_size)) == 3
            && state->keys_numfree < 80
...
{
    ((void) sizeof ((size >= 1) ? 1 : 0), __extension__ ({ if (size >= 1) ; else __assert_fail ("size >= 1", "/home/bag/repos/cpython/Objects/dictobject.c", 707, __extension__ __PRETTY_FUNCTION__); }));
    size_t prefix_size = (((size_t)(size+2) + (size_t)((sizeof(PyObject *)) - 1)) & ~(size_t)((sizeof(PyObject *)) - 1));
    ((void) sizeof ((prefix_size < 256) ? 1 : 0), __extension__ ({ if (prefix_size < 256) ; else __assert_fail ("prefix_size < 256", "/home/bag/repos/cpython/Objects/dictobject.c", 709, __extension__ __PRETTY_FUNCTION__); }));
    size_t n = prefix_size + size * sizeof(PyObject *);
    uint8_t *mem = PyMem_Malloc(n);
    if (mem == ((void *)0)) {
        return ((void *)0);
    }
    ((void) sizeof ((prefix_size % sizeof(PyObject *) == 0) ? 1 : 0), __extension__ ({ if (prefix_size % sizeof(PyObject *) == 0) ; else __assert_fail ("prefix_size % sizeof(PyObject *) == 0", "/home/bag/repos/cpython/Objects/dictobject.c", 715, __extension__ __PRETTY_FUNCTION__); }));
...
{
    PyDictObject *mp;
    ((void) sizeof ((keys != ((void *)0)) ? 1 : 0), __extension__ ({ if (keys != ((void *)0)) ; else __assert_fail ("keys != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 734, __extension__ __PRETTY_FUNCTION__); }));
    struct _Py_dict_state *state = get_dict_state(interp);
    if (state->numfree) {
        mp = state->free_list[--state->numfree];
        ((void) sizeof ((mp != ((void *)0)) ? 1 : 0), __extension__ ({ if (mp != ((void *)0)) ; else __assert_fail ("mp != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 743, __extension__ __PRETTY_FUNCTION__); }));
        ((void) sizeof ((Py_IS_TYPE(((PyObject*)((mp))), (&PyDict_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)((mp))), (&PyDict_Type))) ; else __assert_fail ("Py_IS_TYPE(mp, &PyDict_Type)", "/home/bag/repos/cpython/Objects/dictobject.c", 744, __extension__ __PRETTY_FUNCTION__); }));
        ((void)0);
    ...
    mp->ma_values = values;
    mp->ma_used = used;
    mp->ma_version_tag = ((interp)->dict_state.global_version += (1 << 8));
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(mp), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(mp), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(mp), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 764, __extension__ __PRETTY_FUNCTION__); }));
    return (PyObject *)mp;
}
static inline size_t
...
{
    ((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((orig))))), ((1UL << 29)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((orig))))), ((1UL << 29)))) ; else __assert_fail ("PyDict_Check(orig)", "/home/bag/repos/cpython/Objects/dictobject.c", 795, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((Py_TYPE(((PyObject*)((orig))))->tp_iter == (getiterfunc)dict_iter) ? 1 : 0), __extension__ ({ if (Py_TYPE(((PyObject*)((orig))))->tp_iter == (getiterfunc)dict_iter) ; else __assert_fail ("Py_TYPE(orig)->tp_iter == (getiterfunc)dict_iter", "/home/bag/repos/cpython/Objects/dictobject.c", 796, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((orig->ma_values == ((void *)0)) ? 1 : 0), __extension__ ({ if (orig->ma_values == ((void *)0)) ; else __assert_fail ("orig->ma_values == NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 797, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((orig->ma_keys != &empty_keys_struct) ? 1 : 0), __extension__ ({ if (orig->ma_keys != &empty_keys_struct) ; else __assert_fail ("orig->ma_keys != Py_EMPTY_KEYS", "/home/bag/repos/cpython/Objects/dictobject.c", 798, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((orig->ma_keys->dk_refcnt == 1) ? 1 : 0), __extension__ ({ if (orig->ma_keys->dk_refcnt == 1) ; else __assert_fail ("orig->ma_keys->dk_refcnt == 1", "/home/bag/repos/cpython/Objects/dictobject.c", 799, __extension__ __PRETTY_FUNCTION__); }));
...
{
    PyInterpreterState *interp = _PyInterpreterState_GET();
    return new_dict(interp, &empty_keys_struct, ((void *)0), 0, 0);
}
static Py_ssize_t
lookdict_index(PyDictKeysObject *k, Py_hash_t hash, Py_ssize_t index)
{
    size_t mask = ((((int64_t)1)<<((void)0, ((k)->dk_log2_size)))-1);
...
unicodekeys_lookup_generic(PyDictObject *mp, PyDictKeysObject* dk, PyObject *key, Py_hash_t hash)
{
    ...
    size_t mask = ((((int64_t)1)<<((void)0, ((dk)->dk_log2_size)))-1);
    size_t perturb = hash;
    size_t i = (size_t)hash & mask;
    Py_ssize_t ix;
    for (;;) {
        ...
        if (ix >= 0) {
            ...
            ((void) sizeof ((ep->me_key != ((void *)0)) ? 1 : 0), __extension__ ({ if (ep->me_key != ((void *)0)) ; else __assert_fail ("ep->me_key != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 892, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof ((Py_IS_TYPE(((PyObject*)(((ep->me_key)))), (&PyUnicode_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)(((ep->me_key)))), (&PyUnicode_Type))) ; else __assert_fail ("PyUnicode_CheckExact(ep->me_key)", "/home/bag/repos/cpython/Objects/dictobject.c", 893, __extension__ __PRETTY_FUNCTION__); }));
            if (ep->me_key == key) {
                return ix;
            }
            if (unicode_get_hash(ep->me_key) == hash) {
                PyObject *startkey = ep->me_key;
                Py_INCREF(((PyObject*)((startkey))));
                int cmp = PyObject_RichCompareBool(startkey, key, 2);
                Py_DECREF(((PyObject*)((startkey))));
                if (cmp < 0) {
                    return (-3);
                }
...
unicodekeys_lookup_unicode(PyDictKeysObject* dk, PyObject *key, Py_hash_t hash)
{
    ...
    for (;;) {
        ...
        if (ix >= 0) {
            PyDictUnicodeEntry *ep = &ep0[ix];
            ((void) sizeof ((ep->me_key != ((void *)0)) ? 1 : 0), __extension__ ({ if (ep->me_key != ((void *)0)) ; else __assert_fail ("ep->me_key != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 938, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof ((Py_IS_TYPE(((PyObject*)(((ep->me_key)))), (&PyUnicode_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)(((ep->me_key)))), (&PyUnicode_Type))) ; else __assert_fail ("PyUnicode_CheckExact(ep->me_key)", "/home/bag/repos/cpython/Objects/dictobject.c", 939, __extension__ __PRETTY_FUNCTION__); }));
            if (ep->me_key == key ||
        ...
        if (ix >= 0) {
            PyDictUnicodeEntry *ep = &ep0[ix];
            ((void) sizeof ((ep->me_key != ((void *)0)) ? 1 : 0), __extension__ ({ if (ep->me_key != ((void *)0)) ; else __assert_fail ("ep->me_key != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 954, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof ((Py_IS_TYPE(((PyObject*)(((ep->me_key)))), (&PyUnicode_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)(((ep->me_key)))), (&PyUnicode_Type))) ; else __assert_fail ("PyUnicode_CheckExact(ep->me_key)", "/home/bag/repos/cpython/Objects/dictobject.c", 955, __extension__ __PRETTY_FUNCTION__); }));
            if (ep->me_key == key ||
                    (unicode_get_hash(ep->me_key) == hash && unicode_eq(ep->me_key, key))) {
                return ix;
            }
...
dictkeys_generic_lookup(PyDictObject *mp, PyDictKeysObject* dk, PyObject *key, Py_hash_t hash)
{
    ...
    for (;;) {
        ...
        if (ix >= 0) {
            ...
            ((void) sizeof ((ep->me_key != ((void *)0)) ? 1 : 0), __extension__ ({ if (ep->me_key != ((void *)0)) ; else __assert_fail ("ep->me_key != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 983, __extension__ __PRETTY_FUNCTION__); }));
            if (ep->me_key == key) {
                return ix;
            }
            if (ep->me_hash == hash) {
...
_PyDictKeys_StringLookup(PyDictKeysObject* dk, PyObject *key)
{
    ...
    if (!Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type)) || kind == DICT_KEYS_GENERAL) {
        return (-3);
    }
    Py_hash_t hash = unicode_get_hash(key);
    if (hash == -1) {
...
_PyDict_HasOnlyStringKeys(PyObject *dict)
{
    Py_ssize_t pos = 0;
    PyObject *key, *value;
    ((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((dict))))), ((1UL << 29)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((dict))))), ((1UL << 29)))) ; else __assert_fail ("PyDict_Check(dict)", "/home/bag/repos/cpython/Objects/dictobject.c", 1109, __extension__ __PRETTY_FUNCTION__); }));
    if (((PyDictObject *)dict)->ma_keys->dk_kind != DICT_KEYS_GENERAL)
        return 1;
    while (PyDict_Next(dict, &pos, &key, &value))
        if (!PyType_HasFeature((Py_TYPE(((PyObject*)((key))))), ((1UL << 28))))
            return 0;
    return 1;
}
void
_PyDict_MaybeUntrack(PyObject *op)
{
    ...
    if (!Py_IS_TYPE(((PyObject*)(((op)))), (&PyDict_Type)) || !_PyObject_GC_IS_TRACKED(((PyObject*)(op))))
        return;
    mp = (PyDictObject *) op;
    numentries = mp->ma_keys->dk_nentries;
    if (((mp)->ma_values != ((void *)0))) {
        for (i = 0; i < numentries; i++) {
            if ((value = mp->ma_values->values[i]) == ((void *)0))
                continue;
    ...
    _PyObject_GC_UNTRACK("/home/bag/repos/cpython/Objects/dictobject.c", 1171, ((PyObject*)((op))));
}
static Py_ssize_t
find_empty_slot(PyDictKeysObject *keys, Py_hash_t hash)
{
    ((void) sizeof ((keys != ((void *)0)) ? 1 : 0), __extension__ ({ if (keys != ((void *)0)) ; else __assert_fail ("keys != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1181, __extension__ __PRETTY_FUNCTION__); }));
    const size_t mask = ((((int64_t)1)<<((void)0, ((keys)->dk_log2_size)))-1);
    size_t i = hash & mask;
    Py_ssize_t ix = dictkeys_get_index(keys, i);
...
{
    return dictresize(interp, mp, calculate_log2_keysize(((mp)->ma_used*3)), unicode);
}
static Py_ssize_t
insert_into_dictkeys(PyDictKeysObject *keys, PyObject *name)
{
    ((void) sizeof ((Py_IS_TYPE(((PyObject*)(((name)))), (&PyUnicode_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)(((name)))), (&PyUnicode_Type))) ; else __assert_fail ("PyUnicode_CheckExact(name)", "/home/bag/repos/cpython/Objects/dictobject.c", 1203, __extension__ __PRETTY_FUNCTION__); }));
    ...
    if (ix == (-1)) {
        ...
        ((void) sizeof ((ep->me_key == ((void *)0)) ? 1 : 0), __extension__ ({ if (ep->me_key == ((void *)0)) ; else __assert_fail ("ep->me_key == NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1223, __extension__ __PRETTY_FUNCTION__); }));
        ep->me_key = _Py_NewRef(((PyObject*)((name))));
        keys->dk_usable--;
        keys->dk_nentries++;
    }
    ((void) sizeof ((ix < 30) ? 1 : 0), __extension__ ({ if (ix < 30) ; else __assert_fail ("ix < SHARED_KEYS_MAX_SIZE", "/home/bag/repos/cpython/Objects/dictobject.c", 1228, __extension__ __PRETTY_FUNCTION__); }));
    return ix;
}
static int
...
{
    PyObject *old_value;
    if (((mp->ma_keys)->dk_kind != DICT_KEYS_GENERAL) && !Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type))) {
        if (insertion_resize(interp, mp, 0) < 0)
            goto Fail;
        ((void) sizeof ((mp->ma_keys->dk_kind == DICT_KEYS_GENERAL) ? 1 : 0), __extension__ ({ if (mp->ma_keys->dk_kind == DICT_KEYS_GENERAL) ; else __assert_fail ("mp->ma_keys->dk_kind == DICT_KEYS_GENERAL", "/home/bag/repos/cpython/Objects/dictobject.c", 1247, __extension__ __PRETTY_FUNCTION__); }));
    }
    Py_ssize_t ix = _Py_dict_lookup(mp, key, hash, &old_value);
    if (ix == (-3))
        goto Fail;
    do { if (!_PyObject_GC_IS_TRACKED(((PyObject*)(mp)))) { if (_PyObject_GC_MAY_BE_TRACKED(key) || _PyObject_GC_MAY_BE_TRACKED(value)) { _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 1254, ((PyObject*)((mp)))); } } } while(0);
    if (ix == (-1)) {
        ((void) sizeof ((old_value == ((void *)0)) ? 1 : 0), __extension__ ({ if (old_value == ((void *)0)) ; else __assert_fail ("old_value == NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1257, __extension__ __PRETTY_FUNCTION__); }));
        ...
        if (((mp->ma_keys)->dk_kind != DICT_KEYS_GENERAL)) {
            ...
            if (mp->ma_values) {
                ...
                ((void) sizeof ((mp->ma_values->values[index] == ((void *)0)) ? 1 : 0), __extension__ ({ if (mp->ma_values->values[index] == ((void *)0)) ; else __assert_fail ("mp->ma_values->values[index] == NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1279, __extension__ __PRETTY_FUNCTION__); }));
        ...
        ((void) sizeof ((mp->ma_keys->dk_usable >= 0) ? 1 : 0), __extension__ ({ if (mp->ma_keys->dk_usable >= 0) ; else __assert_fail ("mp->ma_keys->dk_usable >= 0", "/home/bag/repos/cpython/Objects/dictobject.c", 1297, __extension__ __PRETTY_FUNCTION__); }));
        ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(mp), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(mp), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(mp), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 1298, __extension__ __PRETTY_FUNCTION__); }));
        return 0;
    }
    if (old_value != value) {
        uint64_t new_version = _PyDict_NotifyEvent(
        ...
        if (((mp)->ma_values != ((void *)0))) {
            ...
            ((void) sizeof ((old_value != ((void *)0)) ? 1 : 0), __extension__ ({ if (old_value != ((void *)0)) ; else __assert_fail ("old_value != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1313, __extension__ __PRETTY_FUNCTION__); }));
            if (((mp->ma_keys)->dk_kind != DICT_KEYS_GENERAL)) {
    ...
    Py_XDECREF(((PyObject*)((old_value))));
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(mp), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(mp), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(mp), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 1324, __extension__ __PRETTY_FUNCTION__); }));
...
insert_to_emptydict(PyInterpreterState *interp, PyDictObject *mp,
                    PyObject *key, Py_hash_t hash, PyObject *value)
{
    ((void) sizeof ((mp->ma_keys == &empty_keys_struct) ? 1 : 0), __extension__ ({ if (mp->ma_keys == &empty_keys_struct) ; else __assert_fail ("mp->ma_keys == Py_EMPTY_KEYS", "/home/bag/repos/cpython/Objects/dictobject.c", 1340, __extension__ __PRETTY_FUNCTION__); }));
    int unicode = Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type));
    ...
    mp->ma_keys = newkeys;
    mp->ma_values = ((void *)0);
    do { if (!_PyObject_GC_IS_TRACKED(((PyObject*)(mp)))) { if (_PyObject_GC_MAY_BE_TRACKED(key) || _PyObject_GC_MAY_BE_TRACKED(value)) { _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 1357, ((PyObject*)((mp)))); } } } while(0);
...
{
    size_t mask = ((((int64_t)1)<<((void)0, ((keys)->dk_log2_size)))-1);
...
build_indices_unicode(PyDictKeysObject *keys, PyDictUnicodeEntry *ep, Py_ssize_t n)
{
    ...
    for (Py_ssize_t ix = 0; ix != n; ix++, ep++) {
        ...
        ((void) sizeof ((hash != -1) ? 1 : 0), __extension__ ({ if (hash != -1) ; else __assert_fail ("hash != -1", "/home/bag/repos/cpython/Objects/dictobject.c", 1403, __extension__ __PRETTY_FUNCTION__); }));
        size_t i = hash & mask;
        for (size_t perturb = hash; dictkeys_get_index(keys, i) != (-1);) {
            perturb >>= 5;
            i = mask & (i*5 + perturb + 1);
           ...
           uint8_t log2_newsize, int unicode)
{
    ...
    ((void) sizeof ((log2_newsize >= 3) ? 1 : 0), __extension__ ({ if (log2_newsize >= 3) ; else __assert_fail ("log2_newsize >= PyDict_LOG_MINSIZE", "/home/bag/repos/cpython/Objects/dictobject.c", 1438, __extension__ __PRETTY_FUNCTION__); }));
    oldkeys = mp->ma_keys;
    ...
    ((void) sizeof ((mp->ma_keys->dk_usable >= mp->ma_used) ? 1 : 0), __extension__ ({ if (mp->ma_keys->dk_usable >= mp->ma_used) ; else __assert_fail ("mp->ma_keys->dk_usable >= mp->ma_used", "/home/bag/repos/cpython/Objects/dictobject.c", 1459, __extension__ __PRETTY_FUNCTION__); }));
    ...
    if (oldvalues != ((void *)0)) {
        ...
        if (mp->ma_keys->dk_kind == DICT_KEYS_GENERAL) {
            ...
            for (Py_ssize_t i = 0; i < numentries; i++) {
                ...
                ((void) sizeof ((oldvalues->values[index] != ((void *)0)) ? 1 : 0), __extension__ ({ if (oldvalues->values[index] != ((void *)0)) ; else __assert_fail ("oldvalues->values[index] != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1475, __extension__ __PRETTY_FUNCTION__); }));
                newentries[i].me_key = _Py_NewRef(((PyObject*)((ep->me_key))));
            ...
            for (Py_ssize_t i = 0; i < numentries; i++) {
                int index = get_index_from_order(mp, i);
                PyDictUnicodeEntry *ep = &oldentries[index];
                ((void) sizeof ((oldvalues->values[index] != ((void *)0)) ? 1 : 0), __extension__ ({ if (oldvalues->values[index] != ((void *)0)) ; else __assert_fail ("oldvalues->values[index] != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1488, __extension__ __PRETTY_FUNCTION__); }));
                newentries[i].me_key = _Py_NewRef(((PyObject*)((ep->me_key))));
                newentries[i].me_value = oldvalues->values[index];
            }
        ...
        if (oldkeys->dk_kind == DICT_KEYS_GENERAL) {
            ((void) sizeof ((mp->ma_keys->dk_kind == DICT_KEYS_GENERAL) ? 1 : 0), __extension__ ({ if (mp->ma_keys->dk_kind == DICT_KEYS_GENERAL) ; else __assert_fail ("mp->ma_keys->dk_kind == DICT_KEYS_GENERAL", "/home/bag/repos/cpython/Objects/dictobject.c", 1501, __extension__ __PRETTY_FUNCTION__); }));
        ...
        if (oldkeys != &empty_keys_struct) {
            ((void) sizeof ((oldkeys->dk_kind != DICT_KEYS_SPLIT) ? 1 : 0), __extension__ ({ if (oldkeys->dk_kind != DICT_KEYS_SPLIT) ; else __assert_fail ("oldkeys->dk_kind != DICT_KEYS_SPLIT", "/home/bag/repos/cpython/Objects/dictobject.c", 1555, __extension__ __PRETTY_FUNCTION__); }));
            ((void) sizeof ((oldkeys->dk_refcnt == 1) ? 1 : 0), __extension__ ({ if (oldkeys->dk_refcnt == 1) ; else __assert_fail ("oldkeys->dk_refcnt == 1", "/home/bag/repos/cpython/Objects/dictobject.c", 1556, __extension__ __PRETTY_FUNCTION__); }));
            struct _Py_dict_state *state = get_dict_state(interp);
            if (((void)0, ((oldkeys)->dk_log2_size)) == 3 &&
    ...
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(mp), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(mp), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(mp), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 1580, __extension__ __PRETTY_FUNCTION__); }));
    return 0;
}
static PyObject *
dict_new_presized(PyInterpreterState *interp, Py_ssize_t minused, _Bool unicode)
{
    ...
    if (new_keys == ((void *)0))
        return ((void *)0);
    return new_dict(interp, new_keys, ((void *)0), 0, 0);
}
PyObject *
_PyDict_NewPresized(Py_ssize_t minused)
{
    PyInterpreterState *interp = _PyInterpreterState_GET();
    return dict_new_presized(interp, minused, 0);
}
PyObject *
                  ...
                  Py_ssize_t length)
{
    ...
    for (Py_ssize_t i = 0; i < length; i++) {
        if (!Py_IS_TYPE(((PyObject*)(((*ks)))), (&PyUnicode_Type))) {
            unicode = 0;
            break;
        }
        ks += keys_offset;
...
{
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((op))))), ((1UL << 29)))) {
        return ((void *)0);
    }
    PyDictObject *mp = (PyDictObject *)op;
    Py_hash_t hash;
    if (!Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type)) || (hash = unicode_get_hash(key)) == -1) {
    ...
    ((void) sizeof ((ix >= 0 || value == ((void *)0)) ? 1 : 0), __extension__ ({ if (ix >= 0 || value == ((void *)0)) ; else __assert_fail ("ix >= 0 || value == NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1704, __extension__ __PRETTY_FUNCTION__); }));
    return value;
}
Py_ssize_t
...
{
    PyObject *value;
    ((void) sizeof ((Py_IS_TYPE(((PyObject*)((((PyObject*)mp)))), (&PyDict_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)((((PyObject*)mp)))), (&PyDict_Type))) ; else __assert_fail ("PyDict_CheckExact((PyObject*)mp)", "/home/bag/repos/cpython/Objects/dictobject.c", 1712, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type))) ; else __assert_fail ("PyUnicode_CheckExact(key)", "/home/bag/repos/cpython/Objects/dictobject.c", 1713, __extension__ __PRETTY_FUNCTION__); }));
    Py_hash_t hash = unicode_get_hash(key);
    if (hash == -1) {
        hash = PyObject_Hash(key);
        if (hash == -1) {
...
_PyDict_GetItem_KnownHash(PyObject *op, PyObject *key, Py_hash_t hash)
{
    ...
    PyObject *value;
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((op))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 1738);
        return ((void *)0);
    }
    ix = _Py_dict_lookup(mp, key, hash, &value);
    ((void) sizeof ((ix >= 0 || value == ((void *)0)) ? 1 : 0), __extension__ ({ if (ix >= 0 || value == ((void *)0)) ; else __assert_fail ("ix >= 0 || value == NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1743, __extension__ __PRETTY_FUNCTION__); }));
    return value;
}
PyObject *
PyDict_GetItemWithError(PyObject *op, PyObject *key)
{
    ...
    PyObject *value;
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((op))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 1760);
        return ((void *)0);
    }
    if (!Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type)) || (hash = unicode_get_hash(key)) == -1)
    {
    ...
    ix = _Py_dict_lookup(mp, key, hash, &value);
    ((void) sizeof ((ix >= 0 || value == ((void *)0)) ? 1 : 0), __extension__ ({ if (ix >= 0 || value == ((void *)0)) ; else __assert_fail ("ix >= 0 || value == NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1772, __extension__ __PRETTY_FUNCTION__); }));
    return value;
}
PyObject *
_PyDict_GetItemWithError(PyObject *dp, PyObject *kv)
{
    ((void) sizeof ((Py_IS_TYPE(((PyObject*)(((kv)))), (&PyUnicode_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)(((kv)))), (&PyUnicode_Type))) ; else __assert_fail ("PyUnicode_CheckExact(kv)", "/home/bag/repos/cpython/Objects/dictobject.c", 1779, __extension__ __PRETTY_FUNCTION__); }));
...
_PyDict_GetItemIdWithError(PyObject *dp, _Py_Identifier *key)
{
    ...
    ((void) sizeof ((hash != -1) ? 1 : 0), __extension__ ({ if (hash != -1) ; else __assert_fail ("hash != -1", "/home/bag/repos/cpython/Objects/dictobject.c", 1795, __extension__ __PRETTY_FUNCTION__); }));
    return _PyDict_GetItem_KnownHash(dp, kv, hash);
}
PyObject *
...
_PyDict_LoadGlobal(PyDictObject *globals, PyDictObject *builtins, PyObject *key)
{
    ...
    ((void) sizeof ((ix >= 0 || value == ((void *)0)) ? 1 : 0), __extension__ ({ if (ix >= 0 || value == ((void *)0)) ; else __assert_fail ("ix >= 0 || value == NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 1844, __extension__ __PRETTY_FUNCTION__); }));
    return value;
}
int
_PyDict_SetItem_Take2(PyDictObject *mp, PyObject *key, PyObject *value)
{
    ((void) sizeof ((key) ? 1 : 0), __extension__ ({ if (key) ; else __assert_fail ("key", "/home/bag/repos/cpython/Objects/dictobject.c", 1852, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((value) ? 1 : 0), __extension__ ({ if (value) ; else __assert_fail ("value", "/home/bag/repos/cpython/Objects/dictobject.c", 1853, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((mp))))), ((1UL << 29)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((mp))))), ((1UL << 29)))) ; else __assert_fail ("PyDict_Check(mp)", "/home/bag/repos/cpython/Objects/dictobject.c", 1854, __extension__ __PRETTY_FUNCTION__); }));
    Py_hash_t hash;
    if (!Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type)) || (hash = unicode_get_hash(key)) == -1) {
        hash = PyObject_Hash(key);
        if (hash == -1) {
...
{
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((op))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 1882);
        return -1;
    }
    ((void) sizeof ((key) ? 1 : 0), __extension__ ({ if (key) ; else __assert_fail ("key", "/home/bag/repos/cpython/Objects/dictobject.c", 1885, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((value) ? 1 : 0), __extension__ ({ if (value) ; else __assert_fail ("value", "/home/bag/repos/cpython/Objects/dictobject.c", 1886, __extension__ __PRETTY_FUNCTION__); }));
    return _PyDict_SetItem_Take2((PyDictObject *)op,
                                 _Py_NewRef(((PyObject*)((key)))), _Py_NewRef(((PyObject*)((value)))));
}
int
                         ...
                         Py_hash_t hash)
{
    PyDictObject *mp;
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((op))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 1898);
        return -1;
    }
    ((void) sizeof ((key) ? 1 : 0), __extension__ ({ if (key) ; else __assert_fail ("key", "/home/bag/repos/cpython/Objects/dictobject.c", 1901, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((value) ? 1 : 0), __extension__ ({ if (value) ; else __assert_fail ("value", "/home/bag/repos/cpython/Objects/dictobject.c", 1902, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((hash != -1) ? 1 : 0), __extension__ ({ if (hash != -1) ; else __assert_fail ("hash != -1", "/home/bag/repos/cpython/Objects/dictobject.c", 1903, __extension__ __PRETTY_FUNCTION__); }));
    mp = (PyDictObject *)op;
    PyInterpreterState *interp = _PyInterpreterState_GET();
    if (mp->ma_keys == &empty_keys_struct) {
        return insert_to_emptydict(interp, mp, _Py_NewRef(((PyObject*)((key)))), hash, _Py_NewRef(((PyObject*)((value)))));
    }
    return insertdict(interp, mp, _Py_NewRef(((PyObject*)((key)))), hash, _Py_NewRef(((PyObject*)((value)))));
}
static void
delete_index_from_values(PyDictValues *values, Py_ssize_t ix)
{
    ...
    for (i = 1; size_ptr[-i] != ix; i++) {
        ((void) sizeof ((i <= size) ? 1 : 0), __extension__ ({ if (i <= size) ; else __assert_fail ("i <= size", "/home/bag/repos/cpython/Objects/dictobject.c", 1921, __extension__ __PRETTY_FUNCTION__); }));
    }
    ((void) sizeof ((i <= size) ? 1 : 0), __extension__ ({ if (i <= size) ; else __assert_fail ("i <= size", "/home/bag/repos/cpython/Objects/dictobject.c", 1923, __extension__ __PRETTY_FUNCTION__); }));
    for (; i < size; i++) {
               ...
               PyObject *old_value, uint64_t new_version)
{
    ...
    ((void) sizeof ((hashpos >= 0) ? 1 : 0), __extension__ ({ if (hashpos >= 0) ; else __assert_fail ("hashpos >= 0", "/home/bag/repos/cpython/Objects/dictobject.c", 1937, __extension__ __PRETTY_FUNCTION__); }));
    mp->ma_used--;
    mp->ma_version_tag = new_version;
    if (mp->ma_values) {
        ((void) sizeof ((old_value == mp->ma_values->values[ix]) ? 1 : 0), __extension__ ({ if (old_value == mp->ma_values->values[ix]) ; else __assert_fail ("old_value == mp->ma_values->values[ix]", "/home/bag/repos/cpython/Objects/dictobject.c", 1942, __extension__ __PRETTY_FUNCTION__); }));
        mp->ma_values->values[ix] = ((void *)0);
        ((void) sizeof ((ix < 30) ? 1 : 0), __extension__ ({ if (ix < 30) ; else __assert_fail ("ix < SHARED_KEYS_MAX_SIZE", "/home/bag/repos/cpython/Objects/dictobject.c", 1944, __extension__ __PRETTY_FUNCTION__); }));
        delete_index_from_values(mp->ma_values, ix);
        ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(mp), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(mp), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(mp), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 1947, __extension__ __PRETTY_FUNCTION__); }));
    }
    else {
        mp->ma_keys->dk_version = 0;
        ...
        Py_DECREF(((PyObject*)((old_key))));
    }
    Py_DECREF(((PyObject*)((old_value))));
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(mp), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(mp), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(mp), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 1969, __extension__ __PRETTY_FUNCTION__); }));
    return 0;
}
int
...
{
    Py_hash_t hash;
    ((void) sizeof ((key) ? 1 : 0), __extension__ ({ if (key) ; else __assert_fail ("key", "/home/bag/repos/cpython/Objects/dictobject.c", 1977, __extension__ __PRETTY_FUNCTION__); }));
    if (!Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type)) || (hash = unicode_get_hash(key)) == -1) {
        hash = PyObject_Hash(key);
        if (hash == -1)
            return -1;
...
_PyDict_DelItem_KnownHash(PyObject *op, PyObject *key, Py_hash_t hash)
{
    ...
    PyObject *old_value;
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((op))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 1995);
        return -1;
    }
    ((void) sizeof ((key) ? 1 : 0), __extension__ ({ if (key) ; else __assert_fail ("key", "/home/bag/repos/cpython/Objects/dictobject.c", 1998, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((hash != -1) ? 1 : 0), __extension__ ({ if (hash != -1) ; else __assert_fail ("hash != -1", "/home/bag/repos/cpython/Objects/dictobject.c", 1999, __extension__ __PRETTY_FUNCTION__); }));
    mp = (PyDictObject *)op;
    ...
    PyInterpreterState *interp = _PyInterpreterState_GET();
    uint64_t new_version = _PyDict_NotifyEvent(
            interp, PyDict_EVENT_DELETED, mp, key, ((void *)0));
                  ...
                  int (*predicate)(PyObject *value))
{
    ...
    int res;
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((op))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 2030);
        return -1;
    }
    ((void) sizeof ((key) ? 1 : 0), __extension__ ({ if (key) ; else __assert_fail ("key", "/home/bag/repos/cpython/Objects/dictobject.c", 2033, __extension__ __PRETTY_FUNCTION__); }));
    hash = PyObject_Hash(key);
    if (hash == -1)
        return -1;
    mp = (PyDictObject *)op;
    ...
    ((void) sizeof ((hashpos >= 0) ? 1 : 0), __extension__ ({ if (hashpos >= 0) ; else __assert_fail ("hashpos >= 0", "/home/bag/repos/cpython/Objects/dictobject.c", 2051, __extension__ __PRETTY_FUNCTION__); }));
    if (res > 0) {
        PyInterpreterState *interp = _PyInterpreterState_GET();
        uint64_t new_version = _PyDict_NotifyEvent(
                interp, PyDict_EVENT_DELETED, mp, key, ((void *)0));
...
PyDict_Clear(PyObject *op)
{
    ...
    PyInterpreterState *interp = _PyInterpreterState_GET();
    uint64_t new_version = _PyDict_NotifyEvent(
            interp, PyDict_EVENT_CLEARED, mp, ((void *)0), ((void *)0));
    ...
    if (oldvalues != ((void *)0)) {
        ...
        for (i = 0; i < n; i++)
            do { __typeof__(oldvalues->values[i])* _tmp_op_ptr = &(oldvalues->values[i]); __typeof__(oldvalues->values[i]) _tmp_old_op = (*_tmp_op_ptr); if (_tmp_old_op != ((void *)0)) { *_tmp_op_ptr = ((void *)0); Py_DECREF(((PyObject*)((_tmp_old_op)))); } } while (0);
        free_values(oldvalues);
        dictkeys_decref(interp, oldkeys);
    }
    else {
        ((void) sizeof ((oldkeys->dk_refcnt == 1) ? 1 : 0), __extension__ ({ if (oldkeys->dk_refcnt == 1) ; else __assert_fail ("oldkeys->dk_refcnt == 1", "/home/bag/repos/cpython/Objects/dictobject.c", 2098, __extension__ __PRETTY_FUNCTION__); }));
        dictkeys_decref(interp, oldkeys);
    }
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(mp), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(mp), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(mp), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 2101, __extension__ __PRETTY_FUNCTION__); }));
}
int
             ...
             PyObject **pvalue, Py_hash_t *phash)
{
    ...
    i = *ppos;
    if (mp->ma_values) {
        ((void) sizeof ((mp->ma_used <= 30) ? 1 : 0), __extension__ ({ if (mp->ma_used <= 30) ; else __assert_fail ("mp->ma_used <= SHARED_KEYS_MAX_SIZE", "/home/bag/repos/cpython/Objects/dictobject.c", 2123, __extension__ __PRETTY_FUNCTION__); }));
        if (i < 0 || i >= mp->ma_used)
            return 0;
        int index = get_index_from_order(mp, i);
        ...
        ((void) sizeof ((value != ((void *)0)) ? 1 : 0), __extension__ ({ if (value != ((void *)0)) ; else __assert_fail ("value != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 2131, __extension__ __PRETTY_FUNCTION__); }));
    }
    else {
...
_PyDict_Pop_KnownHash(PyObject *dict, PyObject *key, Py_hash_t hash, PyObject *deflt)
{
    ...
    PyDictObject *mp;
    PyInterpreterState *interp = _PyInterpreterState_GET();
    ((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((dict))))), ((1UL << 29)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((dict))))), ((1UL << 29)))) ; else __assert_fail ("PyDict_Check(dict)", "/home/bag/repos/cpython/Objects/dictobject.c", 2205, __extension__ __PRETTY_FUNCTION__); }));
    mp = (PyDictObject *)dict;
    if (mp->ma_used == 0) {
        if (deflt) {
            return _Py_NewRef(((PyObject*)((deflt))));
        }
        _PyErr_SetKeyError(key);
        return ((void *)0);
    }
    ...
    ((void) sizeof ((old_value != ((void *)0)) ? 1 : 0), __extension__ ({ if (old_value != ((void *)0)) ; else __assert_fail ("old_value != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 2225, __extension__ __PRETTY_FUNCTION__); }));
    uint64_t new_version = _PyDict_NotifyEvent(
            interp, PyDict_EVENT_DELETED, mp, key, ((void *)0));
    delitem_common(mp, hash, ix, _Py_NewRef(((PyObject*)((old_value)))), new_version);
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(mp), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(mp), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(mp), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 2230, __extension__ __PRETTY_FUNCTION__); }));
    return old_value;
}
PyObject *
...
_PyDict_FromKeys(PyObject *cls, PyObject *iterable, PyObject *value)
{
    ...
    if (d == ((void *)0))
        return ((void *)0);
    if (Py_IS_TYPE(((PyObject*)(((d)))), (&PyDict_Type)) && ((PyDictObject *)d)->ma_used == 0) {
        if (Py_IS_TYPE(((PyObject*)(((iterable)))), (&PyDict_Type))) {
            PyDictObject *mp = (PyDictObject *)d;
            PyObject *oldvalue;
            Py_ssize_t pos = 0;
            PyObject *key;
            Py_hash_t hash;
            int unicode = ((((PyDictObject*)iterable)->ma_keys)->dk_kind != DICT_KEYS_GENERAL);
            if (dictresize(interp, mp,
                           estimate_log2_keysize(PyDict_GET_SIZE(((PyObject*)((iterable))))),
                           unicode)) {
            ...
            while (_PyDict_Next(iterable, &pos, &key, &oldvalue, &hash)) {
                if (insertdict(interp, mp,
                               _Py_NewRef(((PyObject*)((key)))), hash, _Py_NewRef(((PyObject*)((value)))))) {
                    Py_DECREF(((PyObject*)((d))));
                    return ((void *)0);
                }
            }
        ...
        if ((Py_IS_TYPE(((PyObject*)(((iterable)))), (&PySet_Type)) || Py_IS_TYPE(((PyObject*)(((iterable)))), (&PyFrozenSet_Type)))) {
            PyDictObject *mp = (PyDictObject *)d;
            Py_ssize_t pos = 0;
            PyObject *key;
            Py_hash_t hash;
            if (dictresize(interp, mp,
                           estimate_log2_keysize(PySet_GET_SIZE(((PyObject*)((iterable))))), 0)) {
                Py_DECREF(((PyObject*)((d))));
                return ((void *)0);
            }
            while (_PySet_NextEntry(iterable, &pos, &key, &hash)) {
                if (insertdict(interp, mp, _Py_NewRef(((PyObject*)((key)))), hash, _Py_NewRef(((PyObject*)((value)))))) {
                    Py_DECREF(((PyObject*)((d))));
                    return ((void *)0);
                }
            }
    ...
    if (Py_IS_TYPE(((PyObject*)(((d)))), (&PyDict_Type))) {
...
{
    PyInterpreterState *interp = _PyInterpreterState_GET();
    ((void) sizeof ((Py_REFCNT(((PyObject*)((mp)))) == 0) ? 1 : 0), __extension__ ({ if (Py_REFCNT(((PyObject*)((mp)))) == 0) ; else __assert_fail ("Py_REFCNT(mp) == 0", "/home/bag/repos/cpython/Objects/dictobject.c", 2354, __extension__ __PRETTY_FUNCTION__); }));
    Py_SET_REFCNT(((PyObject*)((mp))), (1));
    _PyDict_NotifyEvent(interp, PyDict_EVENT_DEALLOCATED, mp, ((void *)0), ((void *)0));
    if (Py_REFCNT(((PyObject*)((mp)))) > 1) {
        Py_SET_REFCNT(((PyObject*)((mp))), (Py_REFCNT(((PyObject*)((mp)))) - 1));
        return;
    }
    Py_SET_REFCNT(((PyObject*)((mp))), (0));
    PyDictValues *values = mp->ma_values;
    PyDictKeysObject *keys = mp->ma_keys;
    Py_ssize_t i, n;
    PyObject_GC_UnTrack(mp);
    do { PyThreadState *_tstate = ((void *)0); if (_PyTrash_cond(((PyObject*)((mp))), (destructor)(dict_dealloc))) { _tstate = _PyThreadState_UncheckedGet(); if (_PyTrash_begin(_tstate, ((PyObject*)(((mp)))))) { break; } }
    if (values != ((void *)0)) {
        for (i = 0, n = mp->ma_keys->dk_nentries; i < n; i++) {
            Py_XDECREF(((PyObject*)((values->values[i]))));
        }
        free_values(values);
        dictkeys_decref(interp, keys);
    }
    else if (keys != ((void *)0)) {
        ((void) sizeof ((keys->dk_refcnt == 1 || keys == &empty_keys_struct) ? 1 : 0), __extension__ ({ if (keys->dk_refcnt == 1 || keys == &empty_keys_struct) ; else __assert_fail ("keys->dk_refcnt == 1 || keys == Py_EMPTY_KEYS", "/home/bag/repos/cpython/Objects/dictobject.c", 2377, __extension__ __PRETTY_FUNCTION__); }));
        dictkeys_decref(interp, keys);
    }
    struct _Py_dict_state *state = get_dict_state(interp);
    if (state->numfree < 80 && Py_IS_TYPE(((PyObject*)((mp))), (&PyDict_Type))) {
        state->free_list[state->numfree++] = mp;
        ((void)0);
    }
    else
    {
        Py_TYPE(((PyObject*)((mp))))->tp_free((PyObject *)mp);
    }
...
dict_repr(PyDictObject *mp)
{
    ...
    while (PyDict_Next((PyObject *)mp, &i, &key, &value)) {
        ...
        if (res < 0)
            goto error;
        do { __typeof__(key)* _tmp_op_ptr = &(key); __typeof__(key) _tmp_old_op = (*_tmp_op_ptr); if (_tmp_old_op != ((void *)0)) { *_tmp_op_ptr = ((void *)0); Py_DECREF(((PyObject*)((_tmp_old_op)))); } } while (0);
        do { __typeof__(value)* _tmp_op_ptr = &(value); __typeof__(value) _tmp_old_op = (*_tmp_op_ptr); if (_tmp_old_op != ((void *)0)) { *_tmp_op_ptr = ((void *)0); Py_DECREF(((PyObject*)((_tmp_old_op)))); } } while (0);
    }
...
dict_subscript(PyDictObject *mp, PyObject *key)
{
    ...
    if (ix == (-3))
        return ((void *)0);
    if (ix == (-1) || value == ((void *)0)) {
        if (!Py_IS_TYPE(((PyObject*)(((mp)))), (&PyDict_Type))) {
            PyObject *missing, *res;
            missing = _PyObject_LookupSpecial(
                    (PyObject *)mp, &(_PyRuntime.static_objects.singletons.strings.identifiers._py___missing__._ascii.ob_base));
            if (missing != ((void *)0)) {
                res = PyObject_CallOneArg(missing, key);
                Py_DECREF(((PyObject*)((missing))));
                return res;
            }
    ...
    return _Py_NewRef(((PyObject*)((value))));
}
static int
...
dict_keys(PyDictObject *mp)
{
  ...
  again:
    ...
    PyObject *key;
    while (_PyDict_Next((PyObject*)mp, &pos, &key, ((void *)0), ((void *)0))) {
        ((void) sizeof ((j < n) ? 1 : 0), __extension__ ({ if (j < n) ; else __assert_fail ("j < n", "/home/bag/repos/cpython/Objects/dictobject.c", 2561, __extension__ __PRETTY_FUNCTION__); }));
        PyList_SET_ITEM(((PyObject*)((v))), (j), ((PyObject*)((_Py_NewRef(((PyObject*)((key))))))));
        j++;
    }
    ((void) sizeof ((j == n) ? 1 : 0), __extension__ ({ if (j == n) ; else __assert_fail ("j == n", "/home/bag/repos/cpython/Objects/dictobject.c", 2565, __extension__ __PRETTY_FUNCTION__); }));
    return v;
}
static PyObject *
dict_values(PyDictObject *mp)
{
  ...
  again:
    ...
    Py_ssize_t j = 0, pos = 0;
    PyObject *value;
    while (_PyDict_Next((PyObject*)mp, &pos, ((void *)0), &value, ((void *)0))) {
        ((void) sizeof ((j < n) ? 1 : 0), __extension__ ({ if (j < n) ; else __assert_fail ("j < n", "/home/bag/repos/cpython/Objects/dictobject.c", 2592, __extension__ __PRETTY_FUNCTION__); }));
        PyList_SET_ITEM(((PyObject*)((v))), (j), ((PyObject*)((_Py_NewRef(((PyObject*)((value))))))));
        j++;
    }
    ((void) sizeof ((j == n) ? 1 : 0), __extension__ ({ if (j == n) ; else __assert_fail ("j == n", "/home/bag/repos/cpython/Objects/dictobject.c", 2596, __extension__ __PRETTY_FUNCTION__); }));
    return v;
}
static PyObject *
dict_items(PyDictObject *mp)
{
  ...
  again:
    ...
    for (i = 0; i < n; i++) {
        ...
        PyList_SET_ITEM(((PyObject*)((v))), (i), ((PyObject*)((item))));
    }
    if (n != mp->ma_used) {
        Py_DECREF(((PyObject*)((v))));
        goto again;
    ...
    Py_ssize_t j = 0, pos = 0;
    PyObject *key, *value;
    while (_PyDict_Next((PyObject*)mp, &pos, &key, &value, ((void *)0))) {
        ((void) sizeof ((j < n) ? 1 : 0), __extension__ ({ if (j < n) ; else __assert_fail ("j < n", "/home/bag/repos/cpython/Objects/dictobject.c", 2636, __extension__ __PRETTY_FUNCTION__); }));
        PyObject *item = ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((v))))), ((1UL << 25)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((v))))), ((1UL << 25)))) ; else __assert_fail ("PyList_Check(v)", "/home/bag/repos/cpython/Objects/dictobject.c", 2637, __extension__ __PRETTY_FUNCTION__); })), ((PyListObject*)((v))))->ob_item[(j)]);
        PyTuple_SET_ITEM(((PyObject*)((item))), (0), ((PyObject*)((_Py_NewRef(((PyObject*)((key))))))));
        PyTuple_SET_ITEM(((PyObject*)((item))), (1), ((PyObject*)((_Py_NewRef(((PyObject*)((value))))))));
        j++;
    }
    ((void) sizeof ((j == n) ? 1 : 0), __extension__ ({ if (j == n) ; else __assert_fail ("j == n", "/home/bag/repos/cpython/Objects/dictobject.c", 2642, __extension__ __PRETTY_FUNCTION__); }));
    return v;
}
static PyObject *
dict_fromkeys_impl(PyTypeObject *type, PyObject *iterable, PyObject *value)
...
{
    if (Py_IS_TYPE(((PyObject*)(((arg)))), (&PyDict_Type))) {
        return PyDict_Merge(self, arg, 1);
    }
    PyObject *func;
    if (_PyObject_LookupAttr(arg, &(_PyRuntime.static_objects.singletons.strings.identifiers._py_keys._ascii.ob_base), &func) < 0) {
        return -1;
    }
    if (func != ((void *)0)) {
...
PyDict_MergeFromSeq2(PyObject *d, PyObject *seq2, int override)
{
    ...
    PyObject *item;
    PyObject *fast;
    ((void) sizeof ((d != ((void *)0)) ? 1 : 0), __extension__ ({ if (d != ((void *)0)) ; else __assert_fail ("d != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 2733, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) ; else __assert_fail ("PyDict_Check(d)", "/home/bag/repos/cpython/Objects/dictobject.c", 2734, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((seq2 != ((void *)0)) ? 1 : 0), __extension__ ({ if (seq2 != ((void *)0)) ; else __assert_fail ("seq2 != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 2735, __extension__ __PRETTY_FUNCTION__); }));
    ...
    for (i = 0; ; ++i) {
        ...
        n = (PyType_HasFeature((Py_TYPE(((PyObject*)((fast))))), ((1UL << 25))) ? PyList_GET_SIZE(((PyObject*)((fast)))) : PyTuple_GET_SIZE(((PyObject*)((fast)))));
        if (n != 2) {
        ...
        key = (PyType_HasFeature((Py_TYPE(((PyObject*)((fast))))), ((1UL << 25))) ? ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)(((fast)))))), ((1UL << 25)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)(((fast)))))), ((1UL << 25)))) ; else __assert_fail ("PyList_Check((fast))", "/home/bag/repos/cpython/Objects/dictobject.c", 2773, __extension__ __PRETTY_FUNCTION__); })), ((PyListObject*)(((fast)))))->ob_item[((0))]) : ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)(((fast)))))), ((1UL << 26)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)(((fast)))))), ((1UL << 26)))) ; else __assert_fail ("PyTuple_Check((fast))", "/home/bag/repos/cpython/Objects/dictobject.c", 2773, __extension__ __PRETTY_FUNCTION__); })), ((PyTupleObject*)(((fast)))))->ob_item[((0))]));
        value = (PyType_HasFeature((Py_TYPE(((PyObject*)((fast))))), ((1UL << 25))) ? ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)(((fast)))))), ((1UL << 25)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)(((fast)))))), ((1UL << 25)))) ; else __assert_fail ("PyList_Check((fast))", "/home/bag/repos/cpython/Objects/dictobject.c", 2774, __extension__ __PRETTY_FUNCTION__); })), ((PyListObject*)(((fast)))))->ob_item[((1))]) : ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)(((fast)))))), ((1UL << 26)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)(((fast)))))), ((1UL << 26)))) ; else __assert_fail ("PyTuple_Check((fast))", "/home/bag/repos/cpython/Objects/dictobject.c", 2774, __extension__ __PRETTY_FUNCTION__); })), ((PyTupleObject*)(((fast)))))->ob_item[((1))]));
        Py_INCREF(((PyObject*)((key))));
        Py_INCREF(((PyObject*)((value))));
        if (override) {
            ...
            if (PyDict_SetDefault(d, key, value) == ((void *)0)) {
                Py_DECREF(((PyObject*)((key))));
                Py_DECREF(((PyObject*)((value))));
                goto Fail;
            }
        ...
        Py_DECREF(((PyObject*)((key))));
        Py_DECREF(((PyObject*)((value))));
        Py_DECREF(((PyObject*)((fast))));
        Py_DECREF(((PyObject*)((item))));
    }
    i = 0;
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(d), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(d), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(d), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 2799, __extension__ __PRETTY_FUNCTION__); }));
    goto Return;
Fail:
    Py_XDECREF(((PyObject*)((item))));
    Py_XDECREF(((PyObject*)((fast))));
    i = -1;
Return:
    Py_DECREF(((PyObject*)((it))));
    return ((int)((i)));
...
dict_merge(PyInterpreterState *interp, PyObject *a, PyObject *b, int override)
{
    ...
    ((void) sizeof ((0 <= override && override <= 2) ? 1 : 0), __extension__ ({ if (0 <= override && override <= 2) ; else __assert_fail ("0 <= override && override <= 2", "/home/bag/repos/cpython/Objects/dictobject.c", 2815, __extension__ __PRETTY_FUNCTION__); }));
    if (a == ((void *)0) || !PyType_HasFeature((Py_TYPE(((PyObject*)((a))))), ((1UL << 29))) || b == ((void *)0)) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 2823);
        return -1;
    }
    mp = (PyDictObject*)a;
    if (PyType_HasFeature((Py_TYPE(((PyObject*)((b))))), ((1UL << 29))) && (Py_TYPE(((PyObject*)((b))))->tp_iter == (getiterfunc)dict_iter)) {
        ...
        if (mp->ma_used == 0) {
            ...
            if (other->ma_values == ((void *)0) &&
                    other->ma_used == okeys->dk_nentries &&
                    (((void)0, ((okeys)->dk_log2_size)) == 3 ||
                     ((((((int64_t)1)<<((void)0, ((okeys)->dk_log2_size)))/2) << 1)/3) < other->ma_used)) {
                uint64_t new_version = _PyDict_NotifyEvent(
                        interp, PyDict_EVENT_CLONED, mp, b, ((void *)0));
                ...
                mp->ma_version_tag = new_version;
                ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(mp), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(mp), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(mp), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 2861, __extension__ __PRETTY_FUNCTION__); }));
                if (_PyObject_GC_IS_TRACKED(((PyObject*)(other))) && !_PyObject_GC_IS_TRACKED(((PyObject*)(mp)))) {
                    _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 2865, ((PyObject*)((mp))));
                }
                return 0;
            }
        }
        if (((((((int64_t)1)<<((void)0, ((mp->ma_keys)->dk_log2_size)))) << 1)/3) < other->ma_used) {
            int unicode = ((other->ma_keys)->dk_kind != DICT_KEYS_GENERAL);
            if (dictresize(interp, mp,
    ...
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(a), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(a), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(a), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 2980, __extension__ __PRETTY_FUNCTION__); }));
    return 0;
}
int
...
PyDict_Copy(PyObject *o)
{
    ...
    PyDictObject *mp;
    PyInterpreterState *interp = _PyInterpreterState_GET();
    if (o == ((void *)0) || !PyType_HasFeature((Py_TYPE(((PyObject*)((o))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 3020);
        return ((void *)0);
    }
    mp = (PyDictObject *)o;
    if (mp->ma_used == 0) {
    ...
    if (((mp)->ma_values != ((void *)0))) {
        ...
        split_copy->ma_version_tag = ((interp)->dict_state.global_version += (1 << 8));
        dictkeys_incref(mp->ma_keys);
        for (size_t i = 0; i < size; i++) {
            PyObject *value = mp->ma_values->values[i];
            split_copy->ma_values->values[i] = _Py_XNewRef(((PyObject*)((value))));
        }
        if (_PyObject_GC_IS_TRACKED(((PyObject*)(mp))))
            _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 3053, ((PyObject*)((split_copy))));
        return (PyObject *)split_copy;
    }
    if (Py_TYPE(((PyObject*)((mp))))->tp_iter == (getiterfunc)dict_iter &&
            mp->ma_values == ((void *)0) &&
            (mp->ma_used >= (mp->ma_keys->dk_nentries * 2) / 3))
    {
        ...
        PyDictObject *new = (PyDictObject *)new_dict(interp, keys, ((void *)0), 0, 0);
        if (new == ((void *)0)) {
            return ((void *)0);
        }
        new->ma_used = mp->ma_used;
        ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(new), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(new), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(new), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 3087, __extension__ __PRETTY_FUNCTION__); }));
        if (_PyObject_GC_IS_TRACKED(((PyObject*)(mp)))) {
            _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 3090, ((PyObject*)((new))));
        }
        return (PyObject *)new;
    }
    copy = PyDict_New();
...
{
    if (mp == ((void *)0) || !PyType_HasFeature((Py_TYPE(((PyObject*)((mp))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 3109);
        return -1;
    }
...
{
    if (mp == ((void *)0) || !PyType_HasFeature((Py_TYPE(((PyObject*)((mp))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 3119);
        return ((void *)0);
    }
...
{
    if (mp == ((void *)0) || !PyType_HasFeature((Py_TYPE(((PyObject*)((mp))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 3129);
        return ((void *)0);
    }
...
{
    if (mp == ((void *)0) || !PyType_HasFeature((Py_TYPE(((PyObject*)((mp))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 3139);
        return ((void *)0);
    }
...
dict_equal(PyDictObject *a, PyDictObject *b)
{
    ...
    for (i = 0; i < a->ma_keys->dk_nentries; i++) {
        ...
        if (aval != ((void *)0)) {
            int cmp;
            PyObject *bval;
            Py_INCREF(((PyObject*)((aval))));
            Py_INCREF(((PyObject*)((key))));
            _Py_dict_lookup(b, key, hash, &bval);
            if (bval == ((void *)0)) {
                Py_DECREF(((PyObject*)((key))));
                Py_DECREF(((PyObject*)((aval))));
                if (PyErr_Occurred())
                    return -1;
                return 0;
            }
            Py_INCREF(((PyObject*)((bval))));
            cmp = PyObject_RichCompareBool(aval, bval, 2);
            Py_DECREF(((PyObject*)((key))));
            Py_DECREF(((PyObject*)((aval))));
            Py_DECREF(((PyObject*)((bval))));
            if (cmp <= 0)
                return cmp;
        }
    }
...
dict_richcompare(PyObject *v, PyObject *w, int op)
{
    int cmp;
    PyObject *res;
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((v))))), ((1UL << 29))) || !PyType_HasFeature((Py_TYPE(((PyObject*)((w))))), ((1UL << 29)))) {
        ...
        res = (&_Py_NotImplementedStruct);
    return _Py_NewRef(((PyObject*)((res))));
}
static PyObject *
...
dict_get_impl(PyDictObject *self, PyObject *key, PyObject *default_value)
{
    ...
    return _Py_NewRef(((PyObject*)((val))));
}
PyObject *
PyDict_SetDefault(PyObject *d, PyObject *key, PyObject *defaultobj)
{
    ...
    Py_hash_t hash;
    PyInterpreterState *interp = _PyInterpreterState_GET();
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 3302);
        return ((void *)0);
    }
    if (!Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type)) || (hash = unicode_get_hash(key)) == -1) {
        hash = PyObject_Hash(key);
    ...
    if (mp->ma_keys == &empty_keys_struct) {
        if (insert_to_emptydict(interp, mp, _Py_NewRef(((PyObject*)((key)))), hash,
                                _Py_NewRef(((PyObject*)((defaultobj))))) < 0) {
            return ((void *)0);
        }
        return defaultobj;
    }
    if (!Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type)) && ((mp->ma_keys)->dk_kind != DICT_KEYS_GENERAL)) {
        if (insertion_resize(interp, mp, 0) < 0) {
            return ((void *)0);
        }
    }
    ...
    if (ix == (-1)) {
        ...
        dictkeys_set_index(mp->ma_keys, hashpos, mp->ma_keys->dk_nentries);
        if (((mp->ma_keys)->dk_kind != DICT_KEYS_GENERAL)) {
            ((void) sizeof ((Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)(((key)))), (&PyUnicode_Type))) ; else __assert_fail ("PyUnicode_CheckExact(key)", "/home/bag/repos/cpython/Objects/dictobject.c", 3343, __extension__ __PRETTY_FUNCTION__); }));
            PyDictUnicodeEntry *ep = &DK_UNICODE_ENTRIES(mp->ma_keys)[mp->ma_keys->dk_nentries];
            ep->me_key = _Py_NewRef(((PyObject*)((key))));
            if (((mp)->ma_values != ((void *)0))) {
                Py_ssize_t index = (int)mp->ma_keys->dk_nentries;
                ((void) sizeof ((index < 30) ? 1 : 0), __extension__ ({ if (index < 30) ; else __assert_fail ("index < SHARED_KEYS_MAX_SIZE", "/home/bag/repos/cpython/Objects/dictobject.c", 3348, __extension__ __PRETTY_FUNCTION__); }));
                ((void) sizeof ((mp->ma_values->values[index] == ((void *)0)) ? 1 : 0), __extension__ ({ if (mp->ma_values->values[index] == ((void *)0)) ; else __assert_fail ("mp->ma_values->values[index] == NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 3349, __extension__ __PRETTY_FUNCTION__); }));
                mp->ma_values->values[index] = _Py_NewRef(((PyObject*)((value))));
                _PyDictValues_AddToInsertionOrder(mp->ma_values, index);
            }
            else {
                ep->me_value = _Py_NewRef(((PyObject*)((value))));
            }
        }
        else {
        ...
        do { if (!_PyObject_GC_IS_TRACKED(((PyObject*)(mp)))) { if (_PyObject_GC_MAY_BE_TRACKED(key) || _PyObject_GC_MAY_BE_TRACKED(value)) { _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 3363, ((PyObject*)((mp)))); } } } while(0);
        mp->ma_used++;
        mp->ma_version_tag = new_version;
        mp->ma_keys->dk_usable--;
        mp->ma_keys->dk_nentries++;
        ((void) sizeof ((mp->ma_keys->dk_usable >= 0) ? 1 : 0), __extension__ ({ if (mp->ma_keys->dk_usable >= 0) ; else __assert_fail ("mp->ma_keys->dk_usable >= 0", "/home/bag/repos/cpython/Objects/dictobject.c", 3368, __extension__ __PRETTY_FUNCTION__); }));
    }
    else if (value == ((void *)0)) {
        uint64_t new_version = _PyDict_NotifyEvent(
                interp, PyDict_EVENT_ADDED, mp, key, defaultobj);
        value = defaultobj;
        ((void) sizeof ((((mp)->ma_values != ((void *)0))) ? 1 : 0), __extension__ ({ if (((mp)->ma_values != ((void *)0))) ; else __assert_fail ("_PyDict_HasSplitTable(mp)", "/home/bag/repos/cpython/Objects/dictobject.c", 3374, __extension__ __PRETTY_FUNCTION__); }));
        ((void) sizeof ((mp->ma_values->values[ix] == ((void *)0)) ? 1 : 0), __extension__ ({ if (mp->ma_values->values[ix] == ((void *)0)) ; else __assert_fail ("mp->ma_values->values[ix] == NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 3375, __extension__ __PRETTY_FUNCTION__); }));
        do { if (!_PyObject_GC_IS_TRACKED(((PyObject*)(mp)))) { if (_PyObject_GC_MAY_BE_TRACKED(key) || _PyObject_GC_MAY_BE_TRACKED(value)) { _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 3376, ((PyObject*)((mp)))); } } } while(0);
        mp->ma_values->values[ix] = _Py_NewRef(((PyObject*)((value))));
        _PyDictValues_AddToInsertionOrder(mp->ma_values, ix);
        mp->ma_used++;
        mp->ma_version_tag = new_version;
    }
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(mp), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(mp), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(mp), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 3383, __extension__ __PRETTY_FUNCTION__); }));
    return value;
}
static PyObject *
dict_setdefault_impl(PyDictObject *self, PyObject *key,
                     PyObject *default_value)
{
    ...
    return _Py_XNewRef(((PyObject*)((val))));
}
static PyObject *
...
dict_popitem_impl(PyDictObject *self)
{
    ...
    if (self->ma_keys->dk_kind == DICT_KEYS_SPLIT) {
        if (dictresize(interp, self, ((void)0, ((self->ma_keys)->dk_log2_size)), 1)) {
            Py_DECREF(((PyObject*)((res))));
            return ((void *)0);
        }
    }
    ...
    if (((self->ma_keys)->dk_kind != DICT_KEYS_GENERAL)) {
        ...
        ((void) sizeof ((i >= 0) ? 1 : 0), __extension__ ({ if (i >= 0) ; else __assert_fail ("i >= 0", "/home/bag/repos/cpython/Objects/dictobject.c", 3490, __extension__ __PRETTY_FUNCTION__); }));
        key = ep0[i].me_key;
        new_version = _PyDict_NotifyEvent(
                interp, PyDict_EVENT_DELETED, self, key, ((void *)0));
        hash = unicode_get_hash(key);
        ...
        ((void) sizeof ((i >= 0) ? 1 : 0), __extension__ ({ if (i >= 0) ; else __assert_fail ("i >= 0", "/home/bag/repos/cpython/Objects/dictobject.c", 3506, __extension__ __PRETTY_FUNCTION__); }));
        key = ep0[i].me_key;
        new_version = _PyDict_NotifyEvent(
                interp, PyDict_EVENT_DELETED, self, key, ((void *)0));
        hash = ep0[i].me_hash;
    ...
    ((void) sizeof ((j >= 0) ? 1 : 0), __extension__ ({ if (j >= 0) ; else __assert_fail ("j >= 0", "/home/bag/repos/cpython/Objects/dictobject.c", 3519, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((dictkeys_get_index(self->ma_keys, j) == i) ? 1 : 0), __extension__ ({ if (dictkeys_get_index(self->ma_keys, j) == i) ; else __assert_fail ("dictkeys_get_index(self->ma_keys, j) == i", "/home/bag/repos/cpython/Objects/dictobject.c", 3520, __extension__ __PRETTY_FUNCTION__); }));
    dictkeys_set_index(self->ma_keys, j, (-2));
    PyTuple_SET_ITEM(((PyObject*)((res))), (0), ((PyObject*)((key))));
    PyTuple_SET_ITEM(((PyObject*)((res))), (1), ((PyObject*)((value))));
    self->ma_keys->dk_nentries = i;
    self->ma_used--;
    self->ma_version_tag = new_version;
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(self), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(self), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(self), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 3529, __extension__ __PRETTY_FUNCTION__); }));
    return res;
}
static int
dict_traverse(PyObject *op, visitproc visit, void *arg)
{
    ...
    if (((keys)->dk_kind != DICT_KEYS_GENERAL)) {
        if (mp->ma_values != ((void *)0)) {
            for (i = 0; i < n; i++) {
                do { if (mp->ma_values->values[i]) { int vret = visit(((PyObject*)((mp->ma_values->values[i]))), arg); if (vret) return vret; } } while (0);
            }
        }
        else {
            PyDictUnicodeEntry *entries = DK_UNICODE_ENTRIES(keys);
...
{
    size_t res = _PyObject_SIZE(Py_TYPE(((PyObject*)((mp)))));
    if (mp->ma_values) {
    ...
    ((void) sizeof ((res <= (size_t)0x7fffffffffffffffL) ? 1 : 0), __extension__ ({ if (res <= (size_t)0x7fffffffffffffffL) ; else __assert_fail ("res <= (size_t)PY_SSIZE_T_MAX", "/home/bag/repos/cpython/Objects/dictobject.c", 3586, __extension__ __PRETTY_FUNCTION__); }));
...
_PyDict_KeysSize(PyDictKeysObject *keys)
{
    ...
    size += ((((size_t)(((int64_t)1)<<((void)0, ((keys)->dk_log2_size)))) << 1)/3) * es;
    return size;
}
static PyObject *
...
{
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((self))))), ((1UL << 29))) || !PyType_HasFeature((Py_TYPE(((PyObject*)((other))))), ((1UL << 29)))) {
...
static const char getitem__doc__[] = "__getitem__($self, key, /)\n--\n\nReturn self[key].";
static const char sizeof__doc__[] = "D.__sizeof__() -> size of D in memory, in bytes";
static const char update__doc__[] = "D.update([E, ]**F) -> None.  Update D from mapping/iterable E and F.\nIf E is present and has a .keys() method, then does:  for k in E.keys(): D[k] = E[k]\nIf E is present and lacks a .keys() method, then does:  for k, v in E: D[k] = v\nIn either case, this is followed by: for k in F:  D[k] = F[k]";
...
{
    ((void) sizeof ((type != ((void *)0)) ? 1 : 0), __extension__ ({ if (type != ((void *)0)) ; else __assert_fail ("type != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 3757, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((type->tp_alloc != ((void *)0)) ? 1 : 0), __extension__ ({ if (type->tp_alloc != ((void *)0)) ; else __assert_fail ("type->tp_alloc != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 3758, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((_PyType_HasFeature((type), (1UL << 14))) ? 1 : 0), __extension__ ({ if (_PyType_HasFeature((type), (1UL << 14))) ; else __assert_fail ("_PyType_IS_GC(type)", "/home/bag/repos/cpython/Objects/dictobject.c", 3760, __extension__ __PRETTY_FUNCTION__); }));
    ...
    d->ma_used = 0;
    d->ma_version_tag = ((_PyInterpreterState_GET())->dict_state.global_version += (1 << 8));
    dictkeys_incref(&empty_keys_struct);
    d->ma_keys = &empty_keys_struct;
    d->ma_values = ((void *)0);
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(d), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(d), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(d), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 3774, __extension__ __PRETTY_FUNCTION__); }));
    if (type != &PyDict_Type) {
        if (!_PyObject_GC_IS_TRACKED(((PyObject*)(d)))) {
            _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 3779, ((PyObject*)((d))));
        }
    }
    else {
        ((void) sizeof ((!_PyObject_GC_IS_TRACKED(((PyObject*)(d)))) ? 1 : 0), __extension__ ({ if (!_PyObject_GC_IS_TRACKED(((PyObject*)(d)))) ; else __assert_fail ("!_PyObject_GC_IS_TRACKED(d)", "/home/bag/repos/cpython/Objects/dictobject.c", 3784, __extension__ __PRETTY_FUNCTION__); }));
    }
    return self;
}
static int
...
{
    Py_ssize_t nargs = _PyVectorcall_NARGS(nargsf);
    if (!((!((1) == 0x7fffffffffffffffL) && (0) <= (nargs) && (nargs) <= (1)) || _PyArg_CheckPositional(("dict"), (nargs), (0), (1)))) {
        return ((void *)0);
    }
    PyObject *self = dict_new((((void) sizeof ((PyType_Check(((PyObject*)((type))))) ? 1 : 0), __extension__ ({ if (PyType_Check(((PyObject*)((type))))) ; else __assert_fail ("PyType_Check(type)", "/home/bag/repos/cpython/Objects/dictobject.c", 3804, __extension__ __PRETTY_FUNCTION__); })), ((PyTypeObject*)((type)))), ((void *)0), ((void *)0));
    if (self == ((void *)0)) {
        return ((void *)0);
    }
    if (nargs == 1) {
    ...
    if (kwnames != ((void *)0)) {
        for (Py_ssize_t i = 0; i < PyTuple_GET_SIZE(((PyObject*)((kwnames)))); i++) {
            if (PyDict_SetItem(self, ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((kwnames))))), ((1UL << 26)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((kwnames))))), ((1UL << 26)))) ; else __assert_fail ("PyTuple_Check(kwnames)", "/home/bag/repos/cpython/Objects/dictobject.c", 3817, __extension__ __PRETTY_FUNCTION__); })), ((PyTupleObject*)((kwnames))))->ob_item[(i)]), args[i]) < 0) {
                Py_DECREF(((PyObject*)((self))));
                return ((void *)0);
            }
        }
...
PyDict_SetItemString(PyObject *v, const char *key, PyObject *item)
{
    ...
    if (kv == ((void *)0))
        return -1;
    PyInterpreterState *interp = _PyInterpreterState_GET();
    _PyUnicode_InternImmortal(interp, &kv);
...
dictiter_new(PyDictObject *dict, PyTypeObject *itertype)
{
    ...
    di->di_dict = (PyDictObject*)_Py_NewRef(((PyObject*)((dict))));
    ...
    _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 3997, ((PyObject*)((di))));
    return (PyObject *)di;
}
static void
dictiter_dealloc(dictiterobject *di)
{
    _PyObject_GC_UNTRACK("/home/bag/repos/cpython/Objects/dictobject.c", 4005, ((PyObject*)((di))));
    Py_XDECREF(((PyObject*)((di->di_dict))));
    Py_XDECREF(((PyObject*)((di->di_result))));
    PyObject_GC_Del(di);
}
static int
...
dictiter_iternextkey(dictiterobject *di)
{
    ...
    if (d == ((void *)0))
        return ((void *)0);
    ((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) ; else __assert_fail ("PyDict_Check(d)", "/home/bag/repos/cpython/Objects/dictobject.c", 4054, __extension__ __PRETTY_FUNCTION__); }));
    ...
    i = di->di_pos;
    k = d->ma_keys;
    ((void) sizeof ((i >= 0) ? 1 : 0), __extension__ ({ if (i >= 0) ; else __assert_fail ("i >= 0", "/home/bag/repos/cpython/Objects/dictobject.c", 4065, __extension__ __PRETTY_FUNCTION__); }));
    if (d->ma_values) {
        if (i >= d->ma_used)
            goto fail;
        int index = get_index_from_order(d, i);
        key = DK_UNICODE_ENTRIES(k)[index].me_key;
        ((void) sizeof ((d->ma_values->values[index] != ((void *)0)) ? 1 : 0), __extension__ ({ if (d->ma_values->values[index] != ((void *)0)) ; else __assert_fail ("d->ma_values->values[index] != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 4071, __extension__ __PRETTY_FUNCTION__); }));
    }
    else {
    ...
    di->di_pos = i+1;
    di->len--;
    return _Py_NewRef(((PyObject*)((key))));
fail:
    di->di_dict = ((void *)0);
    Py_DECREF(((PyObject*)((d))));
    return ((void *)0);
...
dictiter_iternextvalue(dictiterobject *di)
{
    ...
    if (d == ((void *)0))
        return ((void *)0);
    ((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) ; else __assert_fail ("PyDict_Check(d)", "/home/bag/repos/cpython/Objects/dictobject.c", 4154, __extension__ __PRETTY_FUNCTION__); }));
    if (di->di_used != d->ma_used) {
        PyErr_SetString(PyExc_RuntimeError,
                        "dictionary changed size during iteration");
        di->di_used = -1;
    ...
    i = di->di_pos;
    ((void) sizeof ((i >= 0) ? 1 : 0), __extension__ ({ if (i >= 0) ; else __assert_fail ("i >= 0", "/home/bag/repos/cpython/Objects/dictobject.c", 4164, __extension__ __PRETTY_FUNCTION__); }));
    if (d->ma_values) {
        if (i >= d->ma_used)
            goto fail;
        int index = get_index_from_order(d, i);
        value = d->ma_values->values[index];
        ((void) sizeof ((value != ((void *)0)) ? 1 : 0), __extension__ ({ if (value != ((void *)0)) ; else __assert_fail ("value != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 4170, __extension__ __PRETTY_FUNCTION__); }));
    }
    else {
...
dictiter_iternextitem(dictiterobject *di)
{
    ...
    if (d == ((void *)0))
        return ((void *)0);
    ((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) ; else __assert_fail ("PyDict_Check(d)", "/home/bag/repos/cpython/Objects/dictobject.c", 4253, __extension__ __PRETTY_FUNCTION__); }));
    if (di->di_used != d->ma_used) {
        PyErr_SetString(PyExc_RuntimeError,
                        "dictionary changed size during iteration");
        di->di_used = -1;
    ...
    i = di->di_pos;
    ((void) sizeof ((i >= 0) ? 1 : 0), __extension__ ({ if (i >= 0) ; else __assert_fail ("i >= 0", "/home/bag/repos/cpython/Objects/dictobject.c", 4263, __extension__ __PRETTY_FUNCTION__); }));
    if (d->ma_values) {
        if (i >= d->ma_used)
            goto fail;
        int index = get_index_from_order(d, i);
        ...
        value = d->ma_values->values[index];
        ((void) sizeof ((value != ((void *)0)) ? 1 : 0), __extension__ ({ if (value != ((void *)0)) ; else __assert_fail ("value != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 4270, __extension__ __PRETTY_FUNCTION__); }));
    }
    else {
        Py_ssize_t n = d->ma_keys->dk_nentries;
        if (((d->ma_keys)->dk_kind != DICT_KEYS_GENERAL)) {
    ...
    if (Py_REFCNT(((PyObject*)((result)))) == 1) {
        PyObject *oldkey = ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((result))))), ((1UL << 26)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((result))))), ((1UL << 26)))) ; else __assert_fail ("PyTuple_Check(result)", "/home/bag/repos/cpython/Objects/dictobject.c", 4307, __extension__ __PRETTY_FUNCTION__); })), ((PyTupleObject*)((result))))->ob_item[(0)]);
        PyObject *oldvalue = ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((result))))), ((1UL << 26)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((result))))), ((1UL << 26)))) ; else __assert_fail ("PyTuple_Check(result)", "/home/bag/repos/cpython/Objects/dictobject.c", 4308, __extension__ __PRETTY_FUNCTION__); })), ((PyTupleObject*)((result))))->ob_item[(1)]);
        PyTuple_SET_ITEM(((PyObject*)((result))), (0), ((PyObject*)((_Py_NewRef(((PyObject*)((key))))))));
        PyTuple_SET_ITEM(((PyObject*)((result))), (1), ((PyObject*)((_Py_NewRef(((PyObject*)((value))))))));
        Py_INCREF(((PyObject*)((result))));
        Py_DECREF(((PyObject*)((oldkey))));
        Py_DECREF(((PyObject*)((oldvalue))));
        if (!_PyObject_GC_IS_TRACKED(((PyObject*)(result)))) {
            _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 4317, ((PyObject*)((result))));
        }
    }
    else {
...
dictreviter_iternext(dictiterobject *di)
{
    ...
    ((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((d))))), ((1UL << 29)))) ; else __assert_fail ("PyDict_Check(d)", "/home/bag/repos/cpython/Objects/dictobject.c", 4379, __extension__ __PRETTY_FUNCTION__); }));
    if (di->di_used != d->ma_used) {
        PyErr_SetString(PyExc_RuntimeError,
                         "dictionary changed size during iteration");
        di->di_used = -1;
    ...
    if (d->ma_values) {
        ...
        key = DK_UNICODE_ENTRIES(k)[index].me_key;
        value = d->ma_values->values[index];
        ((void) sizeof ((value != ((void *)0)) ? 1 : 0), __extension__ ({ if (value != ((void *)0)) ; else __assert_fail ("value != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 4399, __extension__ __PRETTY_FUNCTION__); }));
    }
    else {
        if (((k)->dk_kind != DICT_KEYS_GENERAL)) {
            PyDictUnicodeEntry *entry_ptr = &DK_UNICODE_ENTRIES(k)[i];
    ...
    di->di_pos = i-1;
    di->len--;
    if (Py_IS_TYPE(((PyObject*)((di))), (&PyDictRevIterKey_Type))) {
        return _Py_NewRef(((PyObject*)((key))));
    }
    else if (Py_IS_TYPE(((PyObject*)((di))), (&PyDictRevIterValue_Type))) {
        return _Py_NewRef(((PyObject*)((value))));
    }
    else if (Py_IS_TYPE(((PyObject*)((di))), (&PyDictRevIterItem_Type))) {
        result = di->di_result;
        if (Py_REFCNT(((PyObject*)((result)))) == 1) {
            PyObject *oldkey = ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((result))))), ((1UL << 26)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((result))))), ((1UL << 26)))) ; else __assert_fail ("PyTuple_Check(result)", "/home/bag/repos/cpython/Objects/dictobject.c", 4437, __extension__ __PRETTY_FUNCTION__); })), ((PyTupleObject*)((result))))->ob_item[(0)]);
            PyObject *oldvalue = ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((result))))), ((1UL << 26)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((result))))), ((1UL << 26)))) ; else __assert_fail ("PyTuple_Check(result)", "/home/bag/repos/cpython/Objects/dictobject.c", 4438, __extension__ __PRETTY_FUNCTION__); })), ((PyTupleObject*)((result))))->ob_item[(1)]);
            PyTuple_SET_ITEM(((PyObject*)((result))), (0), ((PyObject*)((_Py_NewRef(((PyObject*)((key))))))));
            PyTuple_SET_ITEM(((PyObject*)((result))), (1), ((PyObject*)((_Py_NewRef(((PyObject*)((value))))))));
            Py_INCREF(((PyObject*)((result))));
            Py_DECREF(((PyObject*)((oldkey))));
            Py_DECREF(((PyObject*)((oldvalue))));
            if (!_PyObject_GC_IS_TRACKED(((PyObject*)(result)))) {
                _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 4447, ((PyObject*)((result))));
            }
        }
        else {
            result = PyTuple_New(2);
...
dict___reversed___impl(PyDictObject *self)
{
    ((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((self))))), ((1UL << 29)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((self))))), ((1UL << 29)))) ; else __assert_fail ("PyDict_Check(self)", "/home/bag/repos/cpython/Objects/dictobject.c", 4493, __extension__ __PRETTY_FUNCTION__); }));
...
dictiter_reduce(dictiterobject *di, PyObject *_unused_ignored __attribute__((unused)))
{
    ...
    Py_XINCREF(((PyObject*)((tmp.di_dict))));
    PyObject *list = PySequence_List((PyObject*)&tmp);
    Py_XDECREF(((PyObject*)((tmp.di_dict))));
    if (list == ((void *)0)) {
        return ((void *)0);
    }
    return Py_BuildValue("N(N)", _PyEval_GetBuiltin(&(_PyRuntime.static_objects.singletons.strings.identifiers._py_iter._ascii.ob_base)), list);
}
...
{
    _PyObject_GC_UNTRACK("/home/bag/repos/cpython/Objects/dictobject.c", 4545, ((PyObject*)((dv))));
    Py_XDECREF(((PyObject*)((dv->dv_dict))));
    PyObject_GC_Del(dv);
}
static int
...
_PyDictView_New(PyObject *dict, PyTypeObject *type)
{
    ...
    if (dict == ((void *)0)) {
        _PyErr_BadInternalCall("/home/bag/repos/cpython/Objects/dictobject.c", 4571);
        return ((void *)0);
    }
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((dict))))), ((1UL << 29)))) {
        PyErr_Format(PyExc_TypeError,
                     "%s() requires a dict argument, not '%s'",
                     type->tp_name, Py_TYPE(((PyObject*)((dict))))->tp_name);
        return ((void *)0);
    }
    dv = ((_PyDictViewObject*)(_PyObject_GC_New(type)));
    if (dv == ((void *)0))
        return ((void *)0);
    dv->dv_dict = (PyDictObject *)_Py_NewRef(((PyObject*)((dict))));
    _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 4585, ((PyObject*)((dv))));
    return (PyObject *)dv;
}
static PyObject *
dictview_mapping(PyObject *view, void *_unused_ignored __attribute__((unused))) {
    ((void) sizeof ((view != ((void *)0)) ? 1 : 0), __extension__ ({ if (view != ((void *)0)) ; else __assert_fail ("view != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 4591, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((PyObject_TypeCheck(((PyObject*)(((view)))), (&PyDictKeys_Type)) || PyObject_TypeCheck(((PyObject*)(((view)))), (&PyDictValues_Type)) || PyObject_TypeCheck(((PyObject*)(((view)))), (&PyDictItems_Type))) ? 1 : 0), __extension__ ({ if (PyObject_TypeCheck(((PyObject*)(((view)))), (&PyDictKeys_Type)) || PyObject_TypeCheck(((PyObject*)(((view)))), (&PyDictValues_Type)) || PyObject_TypeCheck(((PyObject*)(((view)))), (&PyDictItems_Type))) ; else __assert_fail ("PyDictKeys_Check(view) || PyDictValues_Check(view) || PyDictItems_Check(view)", "/home/bag/repos/cpython/Objects/dictobject.c", 4592, __extension__ __PRETTY_FUNCTION__); }));
    PyObject *mapping = (PyObject *)((_PyDictViewObject *)view)->dv_dict;
    return PyDictProxy_New(mapping);
}
static PyGetSetDef dictview_getset[] = {
    {"mapping", dictview_mapping, (setter)((void *)0),
     "dictionary that this view refers to", ((void *)0)},
    {0}
};
static int
...
dictview_richcompare(PyObject *self, PyObject *other, int op)
{
    ...
    int ok;
    PyObject *result;
    ((void) sizeof ((self != ((void *)0)) ? 1 : 0), __extension__ ({ if (self != ((void *)0)) ; else __assert_fail ("self != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 4646, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof (((PyObject_TypeCheck(((PyObject*)(((self)))), (&PyDictKeys_Type)) || PyObject_TypeCheck(((PyObject*)(((self)))), (&PyDictItems_Type)))) ? 1 : 0), __extension__ ({ if ((PyObject_TypeCheck(((PyObject*)(((self)))), (&PyDictKeys_Type)) || PyObject_TypeCheck(((PyObject*)(((self)))), (&PyDictItems_Type)))) ; else __assert_fail ("PyDictViewSet_Check(self)", "/home/bag/repos/cpython/Objects/dictobject.c", 4647, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((other != ((void *)0)) ? 1 : 0), __extension__ ({ if (other != ((void *)0)) ; else __assert_fail ("other != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 4648, __extension__ __PRETTY_FUNCTION__); }));
    if (!(Py_IS_TYPE(((PyObject*)(((other)))), (&PySet_Type)) || Py_IS_TYPE(((PyObject*)(((other)))), (&PyFrozenSet_Type)) || PyType_IsSubtype(Py_TYPE(((PyObject*)((other)))), &PySet_Type) || PyType_IsSubtype(Py_TYPE(((PyObject*)((other)))), &PyFrozenSet_Type)) && !(PyObject_TypeCheck(((PyObject*)(((other)))), (&PyDictKeys_Type)) || PyObject_TypeCheck(((PyObject*)(((other)))), (&PyDictItems_Type))))
        return (&_Py_NotImplementedStruct);
    ...
    return _Py_NewRef(((PyObject*)((result))));
}
static PyObject *
dictview_repr(_PyDictViewObject *dv)
{
    ...
    result = PyUnicode_FromFormat("%s(%R)", Py_TYPE(((PyObject*)((dv))))->tp_name, seq);
...
{
    PyObject *left = self;
    if (PyObject_TypeCheck(((PyObject*)(((self)))), (&PyDictKeys_Type))) {
        PyObject *dict = (PyObject *)((_PyDictViewObject *)self)->dv_dict;
        if (Py_IS_TYPE(((PyObject*)(((dict)))), (&PyDict_Type))) {
            left = dict;
        }
    }
...
dictviews_sub(PyObject *self, PyObject *other)
{
    ...
    PyObject *tmp = PyObject_CallMethodOneArg(
            result, &(_PyRuntime.static_objects.singletons.strings.identifiers._py_difference_update._ascii.ob_base), other);
    if (tmp == ((void *)0)) {
...
_PyDictView_Intersect(PyObject* self, PyObject *other)
{
    ...
    if (!(PyObject_TypeCheck(((PyObject*)(((self)))), (&PyDictKeys_Type)) || PyObject_TypeCheck(((PyObject*)(((self)))), (&PyDictItems_Type)))) {
        PyObject *tmp = other;
        other = self;
        self = tmp;
    }
    len_self = dictview_len((_PyDictViewObject *)self);
    if (Py_IS_TYPE(((PyObject*)((other))), (&PySet_Type)) && len_self <= PyObject_Size(other)) {
        return PyObject_CallMethodObjArgs(
                other, &(_PyRuntime.static_objects.singletons.strings.identifiers._py_intersection._ascii.ob_base), self, ((void *)0));
    }
    if ((PyObject_TypeCheck(((PyObject*)(((other)))), (&PyDictKeys_Type)) || PyObject_TypeCheck(((PyObject*)(((other)))), (&PyDictItems_Type)))) {
...
{
    ((void) sizeof ((PyObject_TypeCheck(((PyObject*)(((self)))), (&PyDictItems_Type))) ? 1 : 0), __extension__ ({ if (PyObject_TypeCheck(((PyObject*)(((self)))), (&PyDictItems_Type))) ; else __assert_fail ("PyDictItems_Check(self)", "/home/bag/repos/cpython/Objects/dictobject.c", 4893, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((PyObject_TypeCheck(((PyObject*)(((other)))), (&PyDictItems_Type))) ? 1 : 0), __extension__ ({ if (PyObject_TypeCheck(((PyObject*)(((other)))), (&PyDictItems_Type))) ; else __assert_fail ("PyDictItems_Check(other)", "/home/bag/repos/cpython/Objects/dictobject.c", 4894, __extension__ __PRETTY_FUNCTION__); }));
    ...
    PyObject *result_set = PySet_New(((void *)0));
    if (result_set == ((void *)0)) {
        do { __typeof__(temp_dict)* _tmp_op_ptr = &(temp_dict); __typeof__(temp_dict) _tmp_old_op = (*_tmp_op_ptr); if (_tmp_old_op != ((void *)0)) { *_tmp_op_ptr = ((void *)0); Py_DECREF(((PyObject*)((_tmp_old_op)))); } } while (0);
        return ((void *)0);
    }
    PyObject *key = ((void *)0), *val1 = ((void *)0), *val2 = ((void *)0);
    Py_ssize_t pos = 0;
    Py_hash_t hash;
    while (_PyDict_Next(d2, &pos, &key, &val2, &hash)) {
        Py_INCREF(((PyObject*)((key))));
        Py_INCREF(((PyObject*)((val2))));
        ...
        if (val1 == ((void *)0)) {
            ...
            Py_INCREF(((PyObject*)((val1))));
            to_delete = PyObject_RichCompareBool(val1, val2, 2);
            if (to_delete < 0) {
                goto error;
            }
        }
        if (to_delete) {
            ...
            if (PySet_Add(result_set, pair) < 0) {
                Py_DECREF(((PyObject*)((pair))));
                goto error;
            }
            Py_DECREF(((PyObject*)((pair))));
        }
        Py_DECREF(((PyObject*)((key))));
        Py_XDECREF(((PyObject*)((val1))));
        Py_DECREF(((PyObject*)((val2))));
    }
    key = val1 = val2 = ((void *)0);
    PyObject *remaining_pairs = PyObject_CallMethodNoArgs(
            temp_dict, &(_PyRuntime.static_objects.singletons.strings.identifiers._py_items._ascii.ob_base));
    if (remaining_pairs == ((void *)0)) {
        goto error;
    }
    if (_PySet_Update(result_set, remaining_pairs) < 0) {
        Py_DECREF(((PyObject*)((remaining_pairs))));
        goto error;
    }
    Py_DECREF(((PyObject*)((temp_dict))));
    Py_DECREF(((PyObject*)((remaining_pairs))));
    return result_set;
error:
    Py_XDECREF(((PyObject*)((temp_dict))));
    Py_XDECREF(((PyObject*)((result_set))));
    Py_XDECREF(((PyObject*)((key))));
    Py_XDECREF(((PyObject*)((val1))));
    Py_XDECREF(((PyObject*)((val2))));
    return ((void *)0);
}
static PyObject*
dictviews_xor(PyObject* self, PyObject *other)
{
    if (PyObject_TypeCheck(((PyObject*)(((self)))), (&PyDictItems_Type)) && PyObject_TypeCheck(((PyObject*)(((other)))), (&PyDictItems_Type))) {
    ...
    PyObject *tmp = PyObject_CallMethodOneArg(
            result, &(_PyRuntime.static_objects.singletons.strings.identifiers._py_symmetric_difference_update._ascii.ob_base), other);
    if (tmp == ((void *)0)) {
        Py_DECREF(((PyObject*)((result))));
        return ((void *)0);
    }
...
dictitems_contains(_PyDictViewObject *dv, PyObject *obj)
{
    ...
    if (dv->dv_dict == ((void *)0))
        return 0;
    if (!PyType_HasFeature((Py_TYPE(((PyObject*)((obj))))), ((1UL << 26))) || PyTuple_GET_SIZE(((PyObject*)((obj)))) != 2)
        return 0;
    key = ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((obj))))), ((1UL << 26)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((obj))))), ((1UL << 26)))) ; else __assert_fail ("PyTuple_Check(obj)", "/home/bag/repos/cpython/Objects/dictobject.c", 5152, __extension__ __PRETTY_FUNCTION__); })), ((PyTupleObject*)((obj))))->ob_item[(0)]);
    value = ((((void) sizeof ((PyType_HasFeature((Py_TYPE(((PyObject*)((obj))))), ((1UL << 26)))) ? 1 : 0), __extension__ ({ if (PyType_HasFeature((Py_TYPE(((PyObject*)((obj))))), ((1UL << 26)))) ; else __assert_fail ("PyTuple_Check(obj)", "/home/bag/repos/cpython/Objects/dictobject.c", 5153, __extension__ __PRETTY_FUNCTION__); })), ((PyTupleObject*)((obj))))->ob_item[(1)]);
    ...
    Py_INCREF(((PyObject*)((found))));
    result = PyObject_RichCompareBool(found, value, 2);
    Py_DECREF(((PyObject*)((found))));
    return result;
}
...
static PyObject* dictitems_reversed(_PyDictViewObject *dv, PyObject *_unused_ignored __attribute__((unused)));
static const char reversed_items_doc[] = "Return a reverse iterator over the dict items.";
static PyMethodDef dictitems_methods[] = {
    {"isdisjoint", (PyCFunction)dictviews_isdisjoint, 0x0008,
     isdisjoint_doc},
    {"__reversed__", (PyCFunction)dictitems_reversed, 0x0004,
     reversed_items_doc},
    {((void *)0), ((void *)0)}
};
...
static PyObject *
dictitems_reversed(_PyDictViewObject *dv, PyObject *_unused_ignored __attribute__((unused)))
{
    if (dv->dv_dict == ((void *)0)) {
        return (&_Py_NoneStruct);
    }
...
static PyObject* dictvalues_reversed(_PyDictViewObject *dv, PyObject *_unused_ignored __attribute__((unused)));
static const char reversed_values_doc[] = "Return a reverse iterator over the dict values.";
static PyMethodDef dictvalues_methods[] = {
    {"__reversed__", (PyCFunction)dictvalues_reversed, 0x0004,
     reversed_values_doc},
    {((void *)0), ((void *)0)}
};
...
static PyObject *
dictvalues_reversed(_PyDictViewObject *dv, PyObject *_unused_ignored __attribute__((unused)))
{
    if (dv->dv_dict == ((void *)0)) {
        return (&_Py_NoneStruct);
    }
...
_PyDict_NewKeysForClass(void)
{
    ...
    if (keys == ((void *)0)) {
        ...
        ((void) sizeof ((keys->dk_nentries == 0) ? 1 : 0), __extension__ ({ if (keys->dk_nentries == 0) ; else __assert_fail ("keys->dk_nentries == 0", "/home/bag/repos/cpython/Objects/dictobject.c", 5332, __extension__ __PRETTY_FUNCTION__); }));
        keys->dk_usable = 30;
...
{
    ((void) sizeof ((tp->tp_flags & (1UL << 9)) ? 1 : 0), __extension__ ({ if (tp->tp_flags & (1UL << 9)) ; else __assert_fail ("tp->tp_flags & Py_TPFLAGS_HEAPTYPE", "/home/bag/repos/cpython/Objects/dictobject.c", 5345, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((tp->tp_flags & (1 << 4)) ? 1 : 0), __extension__ ({ if (tp->tp_flags & (1 << 4)) ; else __assert_fail ("tp->tp_flags & Py_TPFLAGS_MANAGED_DICT", "/home/bag/repos/cpython/Objects/dictobject.c", 5347, __extension__ __PRETTY_FUNCTION__); }));
    PyDictKeysObject *keys = (((PyHeapTypeObject*)tp)->ht_cached_keys);
    ((void) sizeof ((keys != ((void *)0)) ? 1 : 0), __extension__ ({ if (keys != ((void *)0)) ; else __assert_fail ("keys != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 5349, __extension__ __PRETTY_FUNCTION__); }));
    if (keys->dk_usable > 1) {
        keys->dk_usable--;
    }
    size_t size = shared_keys_usable_size(keys);
    ...
    ((void) sizeof ((((uint8_t *)values)[-1] >= (size + 2)) ? 1 : 0), __extension__ ({ if (((uint8_t *)values)[-1] >= (size + 2)) ; else __assert_fail ("((uint8_t *)values)[-1] >= (size + 2)", "/home/bag/repos/cpython/Objects/dictobject.c", 5359, __extension__ __PRETTY_FUNCTION__); }));
    ((uint8_t *)values)[-2] = 0;
    for (size_t i = 0; i < size; i++) {
        values->values[i] = ((void *)0);
    }
...
_PyObject_InitializeDict(PyObject *obj)
{
    ...
    PyObject *dict;
    if (_PyType_HasFeature(tp, (1UL << 9)) && (((PyHeapTypeObject*)tp)->ht_cached_keys)) {
        dictkeys_incref((((PyHeapTypeObject*)tp)->ht_cached_keys));
        dict = new_dict_with_shared_keys(interp, (((PyHeapTypeObject*)tp)->ht_cached_keys));
    }
    else {
        dict = PyDict_New();
    }
                                   ...
                                   PyDictKeysObject *keys, PyDictValues *values)
{
    ...
    if (track && res) {
        _PyObject_GC_TRACK("/home/bag/repos/cpython/Objects/dictobject.c", 5413, ((PyObject*)((res))));
    }
    return res;
}
PyObject *
...
{
    PyInterpreterState *interp = _PyInterpreterState_GET();
    PyDictKeysObject *keys = (((PyHeapTypeObject*)Py_TYPE(((PyObject*)((obj)))))->ht_cached_keys);
    ((void)0);
                              ...
                              PyObject *name, PyObject *value)
{
    PyInterpreterState *interp = _PyInterpreterState_GET();
    PyDictKeysObject *keys = (((PyHeapTypeObject*)Py_TYPE(((PyObject*)((obj)))))->ht_cached_keys);
    ((void) sizeof ((keys != ((void *)0)) ? 1 : 0), __extension__ ({ if (keys != ((void *)0)) ; else __assert_fail ("keys != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 5433, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((values != ((void *)0)) ? 1 : 0), __extension__ ({ if (values != ((void *)0)) ; else __assert_fail ("values != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 5434, __extension__ __PRETTY_FUNCTION__); }));
    ((void) sizeof ((Py_TYPE(((PyObject*)((obj))))->tp_flags & (1 << 4)) ? 1 : 0), __extension__ ({ if (Py_TYPE(((PyObject*)((obj))))->tp_flags & (1 << 4)) ; else __assert_fail ("Py_TYPE(obj)->tp_flags & Py_TPFLAGS_MANAGED_DICT", "/home/bag/repos/cpython/Objects/dictobject.c", 5435, __extension__ __PRETTY_FUNCTION__); }));
    Py_ssize_t ix = (-1);
    if (Py_IS_TYPE(((PyObject*)(((name)))), (&PyUnicode_Type))) {
    ...
    values->values[ix] = _Py_XNewRef(((PyObject*)((value))));
    if (old_value == ((void *)0)) {
        if (value == ((void *)0)) {
            PyErr_Format(PyExc_AttributeError,
                         "'%.100s' object has no attribute '%U'",
                         Py_TYPE(((PyObject*)((obj))))->tp_name, name);
            return -1;
        }
...
_PyObject_GetInstanceAttribute(PyObject *obj, PyDictValues *values,
                              PyObject *name)
{
    ((void) sizeof ((Py_IS_TYPE(((PyObject*)(((name)))), (&PyUnicode_Type))) ? 1 : 0), __extension__ ({ if (Py_IS_TYPE(((PyObject*)(((name)))), (&PyUnicode_Type))) ; else __assert_fail ("PyUnicode_CheckExact(name)", "/home/bag/repos/cpython/Objects/dictobject.c", 5522, __extension__ __PRETTY_FUNCTION__); }));
    PyDictKeysObject *keys = (((PyHeapTypeObject*)Py_TYPE(((PyObject*)((obj)))))->ht_cached_keys);
    ((void) sizeof ((keys != ((void *)0)) ? 1 : 0), __extension__ ({ if (keys != ((void *)0)) ; else __assert_fail ("keys != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 5524, __extension__ __PRETTY_FUNCTION__); }));
    Py_ssize_t ix = _PyDictKeys_StringLookup(keys, name);
    if (ix == (-1)) {
        return ((void *)0);
    }
    PyObject *value = values->values[ix];
    return _Py_XNewRef(((PyObject*)((value))));
}
int
    ...
    if (tp->tp_flags & (1 << 4)) {
        ...
        if (_PyDictOrValues_IsValues(dorv)) {
            ...
            for (Py_ssize_t i = 0; i < keys->dk_nentries; i++) {
                if (_PyDictOrValues_GetValues(dorv)->values[i] != ((void *)0)) {
                    return 0;
                }
            }
            return 1;
...
_PyObject_FreeInstanceAttributes(PyObject *self)
{
    ...
    ((void) sizeof ((Py_TYPE(((PyObject*)((self))))->tp_flags & (1 << 4)) ? 1 : 0), __extension__ ({ if (Py_TYPE(((PyObject*)((self))))->tp_flags & (1 << 4)) ; else __assert_fail ("Py_TYPE(self)->tp_flags & Py_TPFLAGS_MANAGED_DICT", "/home/bag/repos/cpython/Objects/dictobject.c", 5568, __extension__ __PRETTY_FUNCTION__); }));
...
{
    PyTypeObject *tp = Py_TYPE(((PyObject*)((obj))));
    if((tp->tp_flags & (1 << 4)) == 0) {
        return 0;
    }
    ((void) sizeof ((tp->tp_dictoffset) ? 1 : 0), __extension__ ({ if (tp->tp_dictoffset) ; else __assert_fail ("tp->tp_dictoffset", "/home/bag/repos/cpython/Objects/dictobject.c", 5588, __extension__ __PRETTY_FUNCTION__); }));
    PyDictOrValues dorv = *_PyObject_DictOrValuesPointer(obj);
    if (_PyDictOrValues_IsValues(dorv)) {
        PyDictValues *values = _PyDictOrValues_GetValues(dorv);
        PyDictKeysObject *keys = (((PyHeapTypeObject*)tp)->ht_cached_keys);
        for (Py_ssize_t i = 0; i < keys->dk_nentries; i++) {
            do { if (values->values[i]) { int vret = visit(((PyObject*)((values->values[i]))), arg); if (vret) return vret; } } while (0);
        }
    }
    else {
...
_PyObject_ClearManagedDict(PyObject *obj)
{
    ...
    if (_PyDictOrValues_IsValues(*dorv_ptr)) {
        ...
        PyDictKeysObject *keys = (((PyHeapTypeObject*)tp)->ht_cached_keys);
        for (Py_ssize_t i = 0; i < keys->dk_nentries; i++) {
            do { __typeof__(values->values[i])* _tmp_op_ptr = &(values->values[i]); __typeof__(values->values[i]) _tmp_old_op = (*_tmp_op_ptr); if (_tmp_old_op != ((void *)0)) { *_tmp_op_ptr = ((void *)0); Py_DECREF(((PyObject*)((_tmp_old_op)))); } } while (0);
        }
        dorv_ptr->dict = ((void *)0);
        free_values(values);
    }
    else {
...
PyObject_GenericGetDict(PyObject *obj, void *context)
{
    ...
    PyInterpreterState *interp = _PyInterpreterState_GET();
    PyTypeObject *tp = Py_TYPE(((PyObject*)((obj))));
    if (_PyType_HasFeature(tp, (1 << 4))) {
        PyDictOrValues *dorv_ptr = _PyObject_DictOrValuesPointer(obj);
        if (_PyDictOrValues_IsValues(*dorv_ptr)) {
            PyDictValues *values = _PyDictOrValues_GetValues(*dorv_ptr);
            ((void)0);
            dict = make_dict_from_instance_attributes(
                    interp, (((PyHeapTypeObject*)tp)->ht_cached_keys), values);
            if (dict != ((void *)0)) {
                dorv_ptr->dict = dict;
            }
        }
        ...
        if (dict == ((void *)0)) {
            ...
            if (_PyType_HasFeature(tp, (1UL << 9)) && (((PyHeapTypeObject*)tp)->ht_cached_keys)) {
                ...
                *dictptr = dict = new_dict_with_shared_keys(
                        interp, (((PyHeapTypeObject*)tp)->ht_cached_keys));
            }
            else {
    ...
    return _Py_XNewRef(((PyObject*)((dict))));
}
int
                      ...
                      PyObject *key, PyObject *value)
{
    ...
    PyInterpreterState *interp = _PyInterpreterState_GET();
    ((void) sizeof ((dictptr != ((void *)0)) ? 1 : 0), __extension__ ({ if (dictptr != ((void *)0)) ; else __assert_fail ("dictptr != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 5688, __extension__ __PRETTY_FUNCTION__); }));
    if ((tp->tp_flags & (1UL << 9)) && (cached = (((PyHeapTypeObject*)tp)->ht_cached_keys))) {
        ((void) sizeof ((dictptr != ((void *)0)) ? 1 : 0), __extension__ ({ if (dictptr != ((void *)0)) ; else __assert_fail ("dictptr != NULL", "/home/bag/repos/cpython/Objects/dictobject.c", 5690, __extension__ __PRETTY_FUNCTION__); }));
        dict = *dictptr;
        if (dict == ((void *)0)) {
    ...
    ((void) sizeof ((_PyDict_CheckConsistency((PyObject *)(dict), 0)) ? 1 : 0), __extension__ ({ if (_PyDict_CheckConsistency((PyObject *)(dict), 0)) ; else __assert_fail ("_PyDict_CheckConsistency((PyObject *)(dict), 0)", "/home/bag/repos/cpython/Objects/dictobject.c", 5719, __extension__ __PRETTY_FUNCTION__); }));
    return res;
}
void
...
PyDict_ClearWatcher(int watcher_id)
{
    ...
    interp->dict_state.watchers[watcher_id] = ((void *)0);
    return 0;
}
static const char *
dict_event_name(PyDict_WatchEvent event) {
    switch (event) {
        case PyDict_EVENT_ADDED: return "PyDict_EVENT_" "ADDED"; case PyDict_EVENT_MODIFIED: return "PyDict_EVENT_" "MODIFIED"; case PyDict_EVENT_DELETED: return "PyDict_EVENT_" "DELETED"; case PyDict_EVENT_CLONED: return "PyDict_EVENT_" "CLONED"; case PyDict_EVENT_CLEARED: return "PyDict_EVENT_" "CLEARED"; case PyDict_EVENT_DEALLOCATED: return "PyDict_EVENT_" "DEALLOCATED";
    }
    __builtin_unreachable();
}
void
    ...
    for (int i = 0; i < 8; i++) {
        if (watcher_bits & 1) {
            ...
            if (cb && (cb(event, (PyObject*)mp, key, value) < 0)) {
                ...
                if (context == ((void *)0)) {
                    context = _Py_NewRef(((PyObject*)(((&_Py_NoneStruct)))));
                }
